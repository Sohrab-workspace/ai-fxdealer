...
> Source: https://support.metaquotes.net/en/docs/mt5/iphone/settings_accounts/payments
...
[MetaTrader 5](/en/docs/mt5)[iPhone/iPad](/en/docs/mt5/iphone)[Accounts](/en/docs/mt5/iphone/settings_accounts)Deposits and withdrawals
...
Open the 'Settings \\ Deposit' section. It displays the available operations: deposits and/or withdrawals, as well as the payment history.

![Manage your account balance through the Payments section](/en/docs/mt5/iphone/img/payments.png "Manage your account balance through the Payments section")
...
-   Invoice — download a PDF file with an invoice. This option is only used for transactions involving [bank transfers](/en/docs/mt5/iphone/settings_accounts/payments#bank_transfer).
...
![To deposit funds, enter the desired amount and select a payment system](/en/docs/mt5/iphone/img/payments_deposit.png "To deposit funds, enter the desired amount and select a payment system")
...
Some systems supporting card payments offer the option to [add cards](/en/docs/mt5/iphone/settings_accounts/payments#add_card) for future use. With this option, you first add your card to the system, specify its details, and then use it as a ready-made payment method. Adding an account is typically not required for deposit transactions. You can proceed directly to the transaction by selecting "Deposit".
...
Some brokers may conduct additional payment checks before crediting the payment to your account. You can track the status of your transactions in the [transaction history](/en/docs/mt5/iphone/settings_accounts/payments#transactions). If you have questions about your payments, please reach out directly to your broker.

Once the transaction is completed and is approved by the broker, the relevant amount will be credited to your account as a balance operation. This operation will be displayed in the [history section](/en/docs/mt5/iphone/history):

![Depositing operation](/en/docs/mt5/iphone/img/payments_trade_history.png "Depositing operation")
...
Some systems supporting card payments may require prior [card addition](/en/docs/mt5/iphone/settings_accounts/payments#add_card) for future use: You first add your card to the system, specifying its details, and then use it as a ready-made payment method. This is typically required for fund withdrawals.

![Select a payment method to withdraw funds](/en/docs/mt5/iphone/img/payments_withdraw.png "Select a payment method to withdraw funds")
...
Some brokers may conduct additional payment checks before withdrawing funds to the selected card/wallet. In such cases, the amount is debited from your trading account immediately. You will see it in the [history section](/en/docs/mt5/iphone/history). If the transaction fails or is rejected by the broker, the funds will be returned to your account after some time.

![Withdrawal operation](/en/docs/mt5/iphone/img/payments_trade_history.png "Withdrawal operation")

Track the status of your transactions via the [transaction history](/en/docs/mt5/iphone/settings_accounts/payments#transactions). If you have questions about your payments, please reach out directly to your broker.
...
![Adding a card](/en/docs/mt5/iphone/img/payments_add_card.png "Adding a card")
...
![Saved card in the list of payment methods](/en/docs/mt5/iphone/img/payments_saved_card.png "Saved card in the list of payment methods")
...
![Select a bank to deposit funds to your account](/en/docs/mt5/iphone/img/payments_bank_deposit.png "Select a bank to deposit funds to your account")
...
The payment will appear in the [transaction history](/en/docs/mt5/iphone/settings_accounts/payments#transactions) as "Pending". Once the broker receives and processes your transfer, the funds will be credited to your account.
...
![Provide your bank account details to transfer funds](/en/docs/mt5/iphone/img/payments_bank_withdrawal.png "Provide your bank account details to transfer funds")

After filling out the form, a pending payment will appear in the [transaction history](/en/docs/mt5/iphone/settings_accounts/payments#transactions). The withdrawal amount will be debited from your trading account immediately. The broker will process your request and initiate the transfer. Track the transaction status in the transaction history. For any transaction-related queries, please contact your broker directly.

## Deposit and withdrawal links [#](payments#links)

Instead of an internal payment system, the broker may show links to deposit and withdrawal pages on their own website. In this case, the "Payments" section is not visible to you. Instead, you will have the relevant commands in the [trading](/en/docs/mt5/iphone/trade) section and in the current account dialog:

![Fast switch to deposit and withdrawal operations on the broker website](/en/docs/mt5/iphone/img/deposit_withdrawal.png "Fast switch to deposit and withdrawal operations on the broker website")
