...
> Source: https://support.metaquotes.net/en/docs/mt5/manager/lifetime_value_report
...
[MetaTrader 5](/en/docs/mt5)[Manager](/en/docs/mt5/manager)[Server Reports](/en/docs/mt5/manager/reports)Lifetime Value
...
![The "Lifetime Value" report](/en/docs/mt5/manager/img/life_time_value.png "The "Lifetime Value" report")
...
<table class="attentable" cellspacing="0" cellpadding="8" border="1"><tbody><tr class="attentable"><td class="attentable"><ul><li class="p_tableatten"><span class="f_tableatten">Balance operation values reflected in charts are automatically converted to the same currency in accordance with current quotes. The report currency is configured on the trade server side.</span></li></ul><ul><li class="p_tableatten"><span class="f_tableatten">Lead Campaign and Lead Source data are available in appropriate fields of <a href="/en/docs/mt5/manager/account_personal#leadsource" class="topiclink">trading accounts</a>.</span></li></ul></td></tr></tbody></table>
...
This report features FTD (first-time deposit) and LTV (lifetime value) metrics concerning your [clients](/en/docs/mt5/manager/clients) rather than separate accounts. The report collects data on all accounts belonging to a client and generates summary information: the date and amount of the first deposit, as well as the amount of deposits on all accounts over a selected period of time.

![Report "Lifetime Value Detailed by Client"](/en/docs/mt5/manager/img/life_time_value_detailed.png "Report "Lifetime Value Detailed by Client"")
