...
> Source: https://support.metaquotes.net/en/docs/mt5/client/fundamental/economic_indicators_canada/cad_wholesale_sales
...
[MetaTrader 5](/en/docs/mt5)[Client terminal](/en/docs/mt5/client)[Price Charts, Technical and Fundamental Analysis](/en/docs/mt5/client/charts_analysis)[Fundamental Analysis](/en/docs/mt5/client/fundamental)[Canada](/en/docs/mt5/client/fundamental/economic_indicators_canada)Wholesale Sales

# Wholesale Sales

The indicator measures the [total sales for the period at the wholesale level](https://www.mql5.com/en/economic-calendar/canada/wholesale-trade-mm). If the index is growing, it has a positive impact on the national currency, since the sales growth is a good leading signal that a high consumer demand at the retail level is expected.
