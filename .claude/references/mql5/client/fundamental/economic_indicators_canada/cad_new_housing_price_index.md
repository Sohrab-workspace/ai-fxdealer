...
> Source: https://support.metaquotes.net/en/docs/mt5/client/fundamental/economic_indicators_canada/cad_new_housing_price_index
...
[MetaTrader 5](/en/docs/mt5)[Client terminal](/en/docs/mt5/client)[Price Charts, Technical and Fundamental Analysis](/en/docs/mt5/client/charts_analysis)[Fundamental Analysis](/en/docs/mt5/client/fundamental)[Canada](/en/docs/mt5/client/fundamental/economic_indicators_canada)New Housing Price Index

# New Housing Price Index

The index reflects [changes in prices for new housing](https://www.mql5.com/en/economic-calendar/canada/new-housing-price-index-mm) and is part of [CPI](/en/docs/mt5/client/fundamental/economic_indicators_canada/cad_consumer_price_index). Increase in housing prices suggests an increase in consumer demand and growth of the real estate market. At the same time, high real estate prices that accompany economic expansion often lead to inflationary pressures.
