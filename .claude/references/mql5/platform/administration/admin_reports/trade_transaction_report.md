...
> Source: https://support.metaquotes.net/en/docs/mt5/platform/administration/admin_reports/trade_transaction_report
...
[MetaTrader 5](/en/docs/mt5)[Platform](/en/docs/mt5/platform)[Platform Setup](/en/docs/mt5/platform/administration)[Reports](/en/docs/mt5/platform/administration/admin_reports)Trade Transactions
...
The appropriate plugin should be installed to collect the data used in the report. To install the plugin, enter [Plugins](/en/docs/mt5/platform/administration/admin_plugins) section in MetaTrader 5 Administrator. After the server to install the plugin has been selected, click "![Add](/en/docs/mt5/platform/img/add_button.png "Add") Add".

![Configuring the plugin](/en/docs/mt5/platform/img/tradetrans_plugin_config.png "Configuring the plugin")
...
-   Symbol — symbol filter. Groups are separated with a comma. To specify groups, you may also use the mask "\*" and the negation sign "!". For example, the value "EURUSD,GBPUSD" means that the plugin will collect the transaction details for EURUSD and GBPUSD symbols. The value "\*" is for all symbols. \*,!CFD\\\* value is for all symbols except those in the CFD group.
...
To install the plugin, enter [Reports](/en/docs/mt5/platform/administration/admin_reports) section in MetaTrader 5 Administrator. After the server to install the report has been selected, click "![Add](/en/docs/mt5/platform/img/add_button.png "Add") Add".

![Configuring the report](/en/docs/mt5/platform/img/tradetrans_report_config.png "Configuring the report")
...
-   Specify the time, when the file with transactions should be generated, in the "Daily Report Time" parameter. The time is not set by default, so the file is generated at the [end of the trading day](/en/docs/mt5/platform/administration/admin_network/network_add_edit/network_trade_server#end_of_day) (after completion of all day closing procedures).

<table class="attentable" cellspacing="0" cellpadding="8" border="1"><tbody><tr class="attentable"><td class="attentable"><p class="p_tableatten"><span class="f_tableatten">The standard parameters are described in the <a href="/en/docs/mt5/platform/administration/admin_reports" class="topiclink">"Reports"</a> section.</span></p></td></tr></tbody></table>
...
![Requesting the report via MetaTrader 5 Manager](/en/docs/mt5/platform/img/tradetrans_manager_request.png "Requesting the report via MetaTrader 5 Manager")

The request is resulted in the table which can be saved in HTML, CSV or Open XML (MS Office Excel 2007) formats:

![Request result](/en/docs/mt5/platform/img/tradetrans_report_result.png "Request result")
...
-   Reason — [reason](/en/docs/mt5/platform/administration/admin_orders#reason) of the operation execution;
-   Retcode — [result ot execution](https://support.metaquotes.net/en/docs/mt5/api/retcodes_trade_request);
-   Group Owner — name of the company the client is serviced by. It corresponds to Company field in [client group configuration](/en/docs/mt5/platform/administration/admin_groups/groups_settings#company_name).
