...
> Source: https://support.metaquotes.net/en/docs/mt5/platform/administration/automation/automation_statistics
...
[MetaTrader 5](/en/docs/mt5)[Platform](/en/docs/mt5/platform)[Platform Setup](/en/docs/mt5/platform/administration)[Automations](/en/docs/mt5/platform/administration/automation)Statistics
...
![Automation task statistics](/en/docs/mt5/platform/img/automation_statistics.png "Automation task statistics")

The following data is available here:

-   Automation events — the number of automation task [triggers](/en/docs/mt5/platform/administration/automation/automation_trigger).
-   Automation actions / Errors — the number of successful [actions](/en/docs/mt5/platform/administration/automation/automation_action) and the number of execution errors. An action is one row (one setting) in the appropriate task section. Some actions require the execution of multiple operations. For example, this can be sending of emails to a range of logins. If an email is successfully sent to at least one login in the range, the whole action is considered successful.
...
![Automation task statistics](/en/docs/mt5/platform/img/automation_statistics_list.png "Automation task statistics")

To reset the statistics of a certain task, for example, after completing testing, click "Reset" in the "Statistics" tab.

<table class="attentable" cellspacing="0" cellpadding="8" border="1"><tbody><tr class="attentable"><td class="attentable"><p class="p_tableatten"><span class="f_tableatten">Automation statistics are available for the last 30 days. Longer history is not stored.</span></p></td></tr></tbody></table>
