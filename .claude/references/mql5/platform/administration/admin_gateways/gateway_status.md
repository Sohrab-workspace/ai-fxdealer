...
> Source: https://support.metaquotes.net/en/docs/mt5/platform/administration/admin_gateways/gateway_status
...
[MetaTrader 5](/en/docs/mt5)[Platform](/en/docs/mt5/platform)[Platform Setup](/en/docs/mt5/platform/administration)[Gateways](/en/docs/mt5/platform/administration/admin_gateways)Status
...
![Gateway Status](/en/docs/mt5/platform/img/gateway_status.png "Gateway Status")
...
To move to [detailed setup](/en/docs/mt5/platform/administration/admin_gateways/gateways_config), please click ![Settings](/en/docs/mt5/platform/img/configure_button.png "Settings")next to the gateway name.
