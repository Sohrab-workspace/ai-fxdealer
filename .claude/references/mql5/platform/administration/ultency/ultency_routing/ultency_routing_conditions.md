...
> Source: https://support.metaquotes.net/en/docs/mt5/platform/administration/ultency/ultency_routing/ultency_routing_conditions
...
[MetaTrader 5](/en/docs/mt5)[Platform](/en/docs/mt5/platform)[Platform Setup](/en/docs/mt5/platform/administration)[Ultency](/en/docs/mt5/platform/administration/ultency)[Routing](/en/docs/mt5/platform/administration/ultency/ultency_routing)Conditions
...
-   Group, Country, City, Language, Phone, Email, Color, Status, Company  the trading request was submitted from an account that belongs to the specified [group](/en/docs/mt5/platform/administration/admin_accounts/account_edit#account), [country](/en/docs/mt5/platform/administration/admin_accounts/account_edit#personal), [city](/en/docs/mt5/platform/administration/admin_accounts/account_edit#personal), etc.
...
-   Balance — the condition is set relative to the current [account balance](/en/docs/mt5/platform/administration/admin_accounts/account_edit#account_state), the amount is indicated in the [deposit currency](/en/docs/mt5/platform/administration/admin_groups/groups_settings#currency).
...
-   Total positions — the condition is set by the number of open [positions](/en/docs/mt5/platform/administration/admin_positions) that currently exist on the account. This action allows you to control extremely active accounts. For example, set "Total positions > 100", "Group = real\\\*". Assign the action "Decline" to this rule.
...
-   Deposit currency — the request arrived from an account with the specified [deposit currency](/en/docs/mt5/platform/administration/admin_groups/groups_settings#currency).
-   Lead Source, Lead Campaign — [lead source and campaign](/en/docs/mt5/platform/administration/admin_accounts/account_edit#leadsource) parameters specified in the account.
-   Enabled — the condition is specified relative to the "[Enable this account](/en/docs/mt5/platform/administration/admin_accounts/account_edit#enable)" setting.
-   Trading enabled, Algo trading by Expert Advisors enabled — the conditions are set relative to the corresponding [trading settings](/en/docs/mt5/platform/administration/admin_accounts/account_edit#limits).
-   Agent account — the condition is set relative to the [agent account](/en/docs/mt5/platform/administration/admin_accounts/account_edit#agent_account) specified in the trading account settings.
...
-   Reason — the [reason](/en/docs/mt5/platform/administration/admin_orders#reason) for the creation of the request: whether the order was submitted by a client, Expert Advisor, dealer, etc.

-   Price — the price in the request. In the Instant and Request [execution modes](/en/docs/mt5/platform/administration/admin_symbols/admin_symbols_settings/symbol_settings_execution), this is the price specified by the trader in the order. In Market and Exchange modes, this is the current market price of the instrument. Since prices vary significantly between instruments, it is recommended to use this condition in combination with the "Symbol" condition. It can also be used to set the general price threshold. For example, you can decline all requests with a cost of less than one dollar.
-   Value — the value of the requested operation in the symbol's base currency. Value calculation depends on the symbol's [margin/profit calculation mode](/en/docs/mt5/platform/administration/admin_symbols/admin_symbols_settings/symbol_settings_trade#calculation).
...
These settings define conditions based on the [parameters of the position](/en/docs/mt5/platform/administration/admin_positions) affected by the received trading request.
...
These settings define conditions based on [order parameters](/en/docs/mt5/platform/administration/admin_orders).
