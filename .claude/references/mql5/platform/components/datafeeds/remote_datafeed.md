...
> Source: https://support.metaquotes.net/en/docs/mt5/platform/components/datafeeds/remote_datafeed
...
[MetaTrader 5](/en/docs/mt5)[Platform](/en/docs/mt5/platform)[Platform Components](/en/docs/mt5/platform/components)[Data Feeds](/en/docs/mt5/platform/components/datafeeds)Remote Datafeed

# Remote Datafeed

This option in the data feed [settings](/en/docs/mt5/platform/administration/admin_feeds/feed_setup#file) is intended for the connection of the server to a data feed located on a remote server. This data feed can be written using API.

![Remote Datafeed](/en/docs/mt5/platform/img/remote_gateway.png "Remote Datafeed")
