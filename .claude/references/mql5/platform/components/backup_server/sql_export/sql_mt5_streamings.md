...
> Source: https://support.metaquotes.net/en/docs/mt5/platform/components/backup_server/sql_export/sql_mt5_streamings
            ...
            -   [Backup Server](/en/docs/mt5/platform/components/backup_server)
                ...
                -   [SQL Export](/en/docs/mt5/platform/components/backup_server/sql_export)
                    ...
                    -   [mt5\_streamings](/en/docs/mt5/platform/components/backup_server/sql_export/sql_mt5_streamings)
                        -   [Enumerations](/en/docs/mt5/platform/components/backup_server/sql_export/sql_mt5_streamings/streamings_enum)
...
[MetaTrader 5](/en/docs/mt5)[Platform](/en/docs/mt5/platform)[Platform Components](/en/docs/mt5/platform/components)[Backup Server](/en/docs/mt5/platform/components/backup_server)[SQL Export](/en/docs/mt5/platform/components/backup_server/sql_export)mt5\_streamings

# mt5\_streamings

The table stores exported data on [streaming service](/en/docs/mt5/platform/administration/integration/integration_streaming) integration settings. The table contains the following fields:

<table class="table" cellspacing="0" cellpadding="5" border="1"><thead><tr class="table"><th class="table" style="width:200px;"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Name</span></p></th><th class="table" style="width:110px;"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Type</span></p></th><th class="table"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Description</span></p></th></tr></thead><tbody><tr class="table"><td class="table" style="width:200px; height:18px;"><p class="p_fortable"><span class="f_fortable">ID</span></p></td><td class="table" style="width:110px; height:18px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Primary key. A unique identifier of the configuration.</span></p></td></tr><tr class="table"><td class="table" style="width:200px;"><p class="p_fortable"><span class="f_fortable">Timestamp</span></p></td><td class="table" style="width:110px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">A unique values within the table. Used by MetaTrader 5 servers for internal purposes. If the Timestamp value of a record has changed, the record has been modified.</span></p></td></tr><tr class="table"><td class="table" style="width:200px;"><p class="p_fortable"><span class="f_fortable">Name</span></p></td><td class="table" style="width:110px;"><p class="p_fortable"><span class="f_fortable">String</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Configuration name.</span></p></td></tr><tr class="table"><td class="table" style="width:200px;"><p class="p_fortable"><span class="f_fortable">Type</span></p></td><td class="table" style="width:110px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Type of streaming service. Passed using the <a href="/en/docs/mt5/platform/components/backup_server/sql_export/sql_mt5_streamings/streamings_enum#enstreamingtype" class="topiclink">EnStreamingType</a> enumeration.</span></p></td></tr><tr class="table"><td class="table" style="width:200px;"><p class="p_fortable"><span class="f_fortable">Flags</span></p></td><td class="table" style="width:110px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Additional steaming settings. Passed using the <a href="/en/docs/mt5/platform/components/backup_server/sql_export/sql_mt5_streamings/streamings_enum#enflags" class="topiclink">EnFlags</a> enumeration.</span></p></td></tr><tr class="table"><td class="table" style="width:200px;"><p class="p_fortable"><span class="f_fortable">Address</span></p></td><td class="table" style="width:110px;"><p class="p_fortable"><span class="f_fortable">String</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Comma-separated list of streaming service servers.</span></p></td></tr><tr class="table"><td class="table" style="width:200px;"><p class="p_fortable"><span class="f_fortable">Login</span></p></td><td class="table" style="width:110px;"><p class="p_fortable"><span class="f_fortable">String</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Username for connecting to the Kafka cluster.</span></p></td></tr><tr class="table"><td class="table" style="width:200px;"><p class="p_fortable"><span class="f_fortable">Prefix</span></p></td><td class="table" style="width:110px;"><p class="p_fortable"><span class="f_fortable">String</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Prefix added to the <a href="/en/docs/mt5/platform/administration/integration/integration_streaming/kafka_streaming#topic_full_name" class="topiclink">full topic name</a>.</span></p></td></tr><tr class="table"><td class="table" style="width:200px;"><p class="p_fortable"><span class="f_fortable">ProtocolType</span></p></td><td class="table" style="width:110px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Security protocol and authentication type used to connect to the streaming service. Passed using the <a href="/en/docs/mt5/platform/components/backup_server/sql_export/sql_mt5_streamings/streamings_enum#enprotocoltype" class="topiclink">EnProtocolType</a> enumeration.</span></p></td></tr><tr class="table"><td class="table" style="width:200px;"><p class="p_fortable"><span class="f_fortable">CompressionType</span></p></td><td class="table" style="width:110px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Data compression type. Passed using the <a href="/en/docs/mt5/platform/components/backup_server/sql_export/sql_mt5_streamings/streamings_enum#encompressiontype" class="topiclink">EnCompressionType</a> enumeration.</span></p></td></tr></tbody></table>
