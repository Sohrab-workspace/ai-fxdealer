...
> Source: https://support.metaquotes.net/en/docs/mt5/platform/components/backup_server/sql_export/sql_mt5_leverage_tiers
...
[MetaTrader 5](/en/docs/mt5)[Platform](/en/docs/mt5/platform)[Platform Components](/en/docs/mt5/platform/components)[Backup Server](/en/docs/mt5/platform/components/backup_server)[SQL Export](/en/docs/mt5/platform/components/backup_server/sql_export)mt5\_leverage\_tiers

# mt5\_leverage\_tiers

Data on levels in the rules specified in the [floating leverage](/en/docs/mt5/platform/administration/leverages) configuration is exported to this table. The table contains the following fields:

<table class="table" cellspacing="0" cellpadding="5" border="1"><thead><tr class="table"><th class="table" style="width:160px;"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Name</span></p></th><th class="table" style="width:110px;"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Type</span></p></th><th class="table"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Description</span></p></th></tr></thead><tbody><tr class="table"><td class="table" style="width:160px;"><p class="p_fortable"><span class="f_fortable">Tier_ID</span></p></td><td class="table" style="width:110px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Primary key. A unique level identifier required for more optimal querying of its data from the database. The key is assigned automatically upon export.</span></p></td></tr><tr class="table"><td class="table" style="width:160px;"><p class="p_fortable"><span class="f_fortable">Rule_ID</span></p></td><td class="table" style="width:110px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">The identifier of the <a href="/en/docs/mt5/platform/components/backup_server/sql_export/sql_mt5_leverage_rules" class="topiclink">rule</a> to which this level belongs.</span></p></td></tr><tr class="table"><td class="table" style="width:160px;"><p class="p_fortable"><span class="f_fortable">RangeFrom</span></p></td><td class="table" style="width:110px;"><p class="p_fortable"><span class="f_fortable">Float</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">The minimum range value for the level in the floating leverage rule.</span></p></td></tr><tr class="table"><td class="table" style="width:160px; height:16px;"><p class="p_fortable"><span class="f_fortable">RangeTo</span></p></td><td class="table" style="width:110px;"><p class="p_fortable"><span class="f_fortable">Float</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">The maximum range value for the level in the floating leverage rule.</span></p></td></tr><tr class="table"><td class="table" style="width:160px;"><p class="p_fortable"><span class="f_fortable">MarginRateInitial</span></p></td><td class="table" style="width:110px;"><p class="p_fortable"><span class="f_fortable">Float</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Initial margin rate for the level in the floating leverage rule.</span></p></td></tr><tr class="table"><td class="table" style="width:160px;"><p class="p_fortable"><span class="f_fortable">MarginRateMaintenance</span></p></td><td class="table" style="width:110px;"><p class="p_fortable"><span class="f_fortable">Float</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Maintenance margin rate for the level in the floating leverage rule.</span></p></td></tr></tbody></table>
