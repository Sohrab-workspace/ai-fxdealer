...
> Source: https://support.metaquotes.net/en/docs/mt5/platform/components/backup_server/sql_export/sql_mt5_email
...
[MetaTrader 5](/en/docs/mt5)[Platform](/en/docs/mt5/platform)[Platform Components](/en/docs/mt5/platform/components)[Backup Server](/en/docs/mt5/platform/components/backup_server)[SQL Export](/en/docs/mt5/platform/components/backup_server/sql_export)mt5\_email

# mt5\_email

[Mail server](/en/docs/mt5/platform/administration/integration/integration_mail) settings are exported to this table. The table contains the following fields:

<table class="table" cellspacing="0" cellpadding="5" border="1"><thead><tr class="table"><th class="table" style="width:142px;"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Name</span></p></th><th class="table" style="width:106px;"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Type</span></p></th><th class="table"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Description</span></p></th></tr></thead><tbody><tr class="table"><td class="table" style="width:142px;"><p class="p_fortable"><span class="f_fortable">Name</span></p></td><td class="table" style="width:106px;"><p class="p_fortable"><span class="f_fortable">String</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Mail server configuration name.</span></p></td></tr><tr class="table"><td class="table" style="width:142px;"><p class="p_fortable"><span class="f_fortable">Timestamp</span></p></td><td class="table" style="width:106px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">A unique value within the table. Used by MetaTrader 5 servers for internal purposes. If the record's Timestamp value has changed, it means the record has been modified.</span></p></td></tr><tr class="table"><td class="table" style="width:142px; height:9px;"><p class="p_fortable"><span class="f_fortable">SenderMail</span></p></td><td class="table" style="width:106px; height:9px;"><p class="p_fortable"><span class="f_fortable">String</span></p></td><td class="table" style="height:9px;"><p class="p_fortable"><span class="f_fortable">The email address, from which emails are sent via the mail server configurations.</span></p></td></tr><tr class="table"><td class="table" style="width:142px;"><p class="p_fortable"><span class="f_fortable">SenderName</span></p></td><td class="table" style="width:106px;"><p class="p_fortable"><span class="f_fortable">String</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">The sender name in the mail server configuration.</span></p></td></tr><tr class="table"><td class="table" style="width:142px;"><p class="p_fortable"><span class="f_fortable">Server</span></p></td><td class="table" style="width:106px;"><p class="p_fortable"><span class="f_fortable">String</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">The SMTP server address in the mail server configuration.</span></p></td></tr><tr class="table"><td class="table" style="width:142px;"><p class="p_fortable"><span class="f_fortable">Login</span></p></td><td class="table" style="width:106px;"><p class="p_fortable"><span class="f_fortable">String</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">The SMTP login in the mail server configuration.</span></p></td></tr><tr class="table"><td class="table" style="width:142px;"><p class="p_fortable"><span class="f_fortable">Flags</span></p></td><td class="table" style="width:106px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Advanced mail server settings. Transfered via the <a href="https://support.metaquotes.net/ru/docs/mt5/api/config_email/imtconemail/imtconemail_enum#enflags" target="_blank" class="weblink">EnFlags</a> enumeration.</span></p></td></tr></tbody></table>
