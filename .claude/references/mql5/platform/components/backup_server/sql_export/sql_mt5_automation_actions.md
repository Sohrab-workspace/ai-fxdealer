...
> Source: https://support.metaquotes.net/en/docs/mt5/platform/components/backup_server/sql_export/sql_mt5_automation_actions
...
[MetaTrader 5](/en/docs/mt5)[Platform](/en/docs/mt5/platform)[Platform Components](/en/docs/mt5/platform/components)[Backup Server](/en/docs/mt5/platform/components/backup_server)[SQL Export](/en/docs/mt5/platform/components/backup_server/sql_export)mt5\_automation\_actions

# mt5\_automation\_actions

[Actions for automation tasks](/en/docs/mt5/platform/administration/automation/automation_action) are exported to this table. The table contains the following fields:

<table class="table" cellspacing="0" cellpadding="5" border="1"><thead><tr class="table"><th class="table" style="width:142px;"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Name</span></p></th><th class="table" style="width:106px;"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Type</span></p></th><th class="table"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Description</span></p></th></tr></thead><tbody><tr class="table"><td class="table" style="width:142px;"><p class="p_fortable"><span class="f_fortable">Action_ID</span></p></td><td class="table" style="width:106px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Primary key. A unique configuration identifier required for more efficient retrieval of its information from the database. The key is assigned automatically upon export.</span></p></td></tr><tr class="table"><td class="table" style="width:142px;"><p class="p_fortable"><span class="f_fortable">Automation_ID</span></p></td><td class="table" style="width:106px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Identifier of the <a href="/en/docs/mt5/platform/components/backup_server/sql_export/sql_mt5_automations" class="topiclink">automation task</a> to which the action belongs.</span></p></td></tr><tr class="table"><td class="table" style="width:142px;"><p class="p_fortable"><span class="f_fortable">Action</span></p></td><td class="table" style="width:106px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">The action performed when the automation task is triggered. Passed using the <a href="https://support.metaquotes.net/ru/docs/mt5/api/config_automation/imtconautoaction/imtconautoaction_enum#enactions" target="_blank" class="weblink">EnActions</a> enumeration.</span></p></td></tr><tr class="table"><td class="table" style="width:142px;"><p class="p_fortable"><span class="f_fortable">Name</span></p></td><td class="table" style="width:106px;"><p class="p_fortable"><span class="f_fortable">String</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">The name of the action in the automation task.</span></p></td></tr></tbody></table>
