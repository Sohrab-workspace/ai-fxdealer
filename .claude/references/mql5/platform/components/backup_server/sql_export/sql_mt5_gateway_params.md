...
> Source: https://support.metaquotes.net/en/docs/mt5/platform/components/backup_server/sql_export/sql_mt5_gateway_params
...
[MetaTrader 5](/en/docs/mt5)[Platform](/en/docs/mt5/platform)[Platform Components](/en/docs/mt5/platform/components)[Backup Server](/en/docs/mt5/platform/components/backup_server)[SQL Export](/en/docs/mt5/platform/components/backup_server/sql_export)mt5\_gateway\_params

# mt5\_gateway\_params

The table stores exported data on [additional report settings](/en/docs/mt5/platform/administration/admin_gateways/gateways_config#parameters). The table contains the following fields:

<table class="table" cellspacing="0" cellpadding="5" border="1"><thead><tr class="table"><th class="table" style="width:126px;"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Name</span></p></th><th class="table" style="width:110px;"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Type</span></p></th><th class="table"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Description</span></p></th></tr></thead><tbody><tr class="table"><td class="table" style="width:126px;"><p class="p_fortable"><span class="f_fortable">ParamID</span></p></td><td class="table" style="width:110px;"><p class="p_fortable"><span class="f_fortable">String</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">The unique identifier of the parameter.</span></p></td></tr><tr class="table"><td class="table" style="width:126px; height:16px;"><p class="p_fortable"><span class="f_fortable">GatewayName</span></p></td><td class="table" style="width:110px;"><p class="p_fortable"><span class="f_fortable">String</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">The name of the gateway configuration the setting applies to.</span></p></td></tr><tr class="table"><td class="table" style="width:126px;"><p class="p_fortable"><span class="f_fortable">Type</span></p></td><td class="table" style="width:110px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Parameter type:</span></p><ul><li class="p_fortable"><span class="f_fortable">0 — string</span></li><li class="p_fortable"><span class="f_fortable">1 — integer</span></li><li class="p_fortable"><span class="f_fortable">2 — floating-point number</span></li><li class="p_fortable"><span class="f_fortable">3 — time</span></li><li class="p_fortable"><span class="f_fortable">4 — date</span></li><li class="p_fortable"><span class="f_fortable">5 — date and time</span></li><li class="p_fortable"><span class="f_fortable">6 — list of groups</span></li><li class="p_fortable"><span class="f_fortable">7 — list of symbols</span></li></ul><ul><li class="p_fortable"><span class="f_fortable">8 — bool</span></li><li class="p_fortable"><span class="f_fortable">9 — color</span></li></ul></td></tr><tr class="table"><td class="table" style="width:126px;"><p class="p_fortable"><span class="f_fortable">Name</span></p></td><td class="table" style="width:110px;"><p class="p_fortable"><span class="f_fortable">String</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Parameter name.</span></p></td></tr><tr class="table"><td class="table" style="width:126px;"><p class="p_fortable"><span class="f_fortable">Value</span></p></td><td class="table" style="width:110px;"><p class="p_fortable"><span class="f_fortable">String</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Parameter value.</span></p></td></tr></tbody></table>
