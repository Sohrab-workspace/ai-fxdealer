...
> Source: https://support.metaquotes.net/en/docs/mt5/platform/components/backup_server/sql_export/sql_mt5_corporate_links
...
[MetaTrader 5](/en/docs/mt5)[Platform](/en/docs/mt5/platform)[Platform Components](/en/docs/mt5/platform/components)[Backup Server](/en/docs/mt5/platform/components/backup_server)[SQL Export](/en/docs/mt5/platform/components/backup_server/sql_export)mt5\_corporate\_links

# mt5\_corporate\_links

The list of links from [corporate link](/en/docs/mt5/platform/administration/admin_accounts/corporate_links) settings is exported to this table. The table contains the following fields:

<table class="table" cellspacing="0" cellpadding="5" border="1"><thead><tr class="table"><th class="table" style="width:142px;"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Name</span></p></th><th class="table" style="width:106px;"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Type</span></p></th><th class="table"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Description</span></p></th></tr></thead><tbody><tr class="table"><td class="table" style="width:142px;"><p class="p_fortable"><span class="f_fortable">Link_ID</span></p></td><td class="table" style="width:106px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Primary key. A unique link identifier required for more efficient retrieval of its information from the database. The key is assigned automatically upon export.</span></p></td></tr><tr class="table"><td class="table" style="width:142px;"><p class="p_fortable"><span class="f_fortable">Corporate_ID</span></p></td><td class="table" style="width:106px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Identifier of the <a href="/en/docs/mt5/platform/components/backup_server/sql_export/sql_mt5_corporate" class="topiclink">configuration</a> to which the link belongs.</span></p></td></tr><tr class="table"><td class="table" style="width:142px; height:9px;"><p class="p_fortable"><span class="f_fortable">CaptionType</span></p></td><td class="table" style="width:106px; height:9px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table" style="height:9px;"><p class="p_fortable"><span class="f_fortable">Link type. Passed using the <a href="https://support.metaquotes.net/ru/docs/mt5/api/config_common/imtconaccountagreement/imtconaccountagreement_enum#encaptiontype" target="_blank" class="weblink">EnCaptionType</a> enumeration.</span></p></td></tr><tr class="table"><td class="table" style="width:142px;"><p class="p_fortable"><span class="f_fortable">CaptionCustom</span></p></td><td class="table" style="width:106px;"><p class="p_fortable"><span class="f_fortable">String</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Custom link name.</span></p></td></tr><tr class="table"><td class="table" style="width:142px;"><p class="p_fortable"><span class="f_fortable">Url</span></p></td><td class="table" style="width:106px;"><p class="p_fortable"><span class="f_fortable">String</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Link address.</span></p></td></tr><tr class="table"><td class="table" style="width:142px;"><p class="p_fortable"><span class="f_fortable">Flags</span></p></td><td class="table" style="width:106px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Additional settings. The field is currently not in use.</span></p></td></tr></tbody></table>
