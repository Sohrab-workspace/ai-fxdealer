...
> Source: https://support.metaquotes.net/en/docs/mt5/platform/components/backup_server/sql_export/sql_mt5_pay_rules
...
[MetaTrader 5](/en/docs/mt5)[Platform](/en/docs/mt5/platform)[Platform Components](/en/docs/mt5/platform/components)[Backup Server](/en/docs/mt5/platform/components/backup_server)[SQL Export](/en/docs/mt5/platform/components/backup_server/sql_export)mt5\_pay\_rules

# mt5\_pay\_rules

This table stores exported data related to [payment processing rule](/en/docs/mt5/platform/administration/payments/payments_rules) settings. The table contains the following fields:

<table class="table" cellspacing="0" cellpadding="5" border="1"><thead><tr class="table"><th class="table" style="width:157px;"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Name</span></p></th><th class="table" style="width:110px;"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Type</span></p></th><th class="table"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Description</span></p></th></tr></thead><tbody><tr class="table"><td class="table" style="width:157px; height:18px;"><p class="p_fortable"><span class="f_fortable">PaymentRule_ID</span></p></td><td class="table" style="width:110px; height:18px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Primary key. Unique identifier of the rule.</span></p></td></tr><tr class="table"><td class="table" style="width:157px; height:18px;"><p class="p_fortable"><span class="f_fortable">Timestamp</span></p></td><td class="table" style="width:110px; height:18px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">A unique values within the table. Used by MetaTrader 5 servers for internal purposes. If the Timestamp value of a record has changed, the record has been modified.</span></p></td></tr><tr class="table"><td class="table" style="width:157px; height:18px;"><p class="p_fortable"><span class="f_fortable">Name</span></p></td><td class="table" style="width:110px; height:18px;"><p class="p_fortable"><span class="f_fortable">String</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Rule name.</span></p></td></tr><tr class="table"><td class="table" style="width:157px; height:18px;"><p class="p_fortable"><span class="f_fortable">Mode</span></p></td><td class="table" style="width:110px; height:18px;"><p class="p_fortable"><span class="f_fortable">&nbsp;</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Rule status:</span></p><ul><li class="p_fortable"><span class="f_fortable">0 — disabled</span></li><li class="p_fortable"><span class="f_fortable">1 — enabled</span></li></ul></td></tr><tr class="table"><td class="table" style="width:157px; height:18px;"><p class="p_fortable"><span class="f_fortable">Payment</span></p></td><td class="table" style="width:110px; height:18px;"><p class="p_fortable"><span class="f_fortable">&nbsp;</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Currently unused.</span></p></td></tr><tr class="table"><td class="table" style="width:157px; height:18px;"><p class="p_fortable"><span class="f_fortable">Flags</span></p></td><td class="table" style="width:110px; height:18px;"><p class="p_fortable"><span class="f_fortable">&nbsp;</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Currently unused.</span></p></td></tr><tr class="table"><td class="table" style="width:157px; height:18px;"><p class="p_fortable"><span class="f_fortable">Action</span></p></td><td class="table" style="width:110px; height:18px;"><p class="p_fortable"><span class="f_fortable">&nbsp;</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">The action to be applied to the transaction that matches the rule conditions. Passed using the <a href="/en/docs/mt5/platform/components/backup_server/sql_export/sql_mt5_pay_wallets/pay_wallets_enum#enaction" class="topiclink">EnAction</a> enumeration.</span></p></td></tr><tr class="table"><td class="table" style="width:157px; height:18px;"><p class="p_fortable"><span class="f_fortable">ActionDesc</span></p></td><td class="table" style="width:110px; height:18px;"><p class="p_fortable"><span class="f_fortable">&nbsp;</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Rule description.</span></p></td></tr></tbody></table>
