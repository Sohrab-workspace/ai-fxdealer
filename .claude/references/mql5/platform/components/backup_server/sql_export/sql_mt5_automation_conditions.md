...
> Source: https://support.metaquotes.net/en/docs/mt5/platform/components/backup_server/sql_export/sql_mt5_automation_conditions
...
[MetaTrader 5](/en/docs/mt5)[Platform](/en/docs/mt5/platform)[Platform Components](/en/docs/mt5/platform/components)[Backup Server](/en/docs/mt5/platform/components/backup_server)[SQL Export](/en/docs/mt5/platform/components/backup_server/sql_export)mt5\_automation\_conditions

# mt5\_automation\_conditions

[Conditions for automation tasks](/en/docs/mt5/platform/administration/automation/automation_condition) are exported to this table. The table contains the following fields:

<table class="table" cellspacing="0" cellpadding="5" border="1"><thead><tr class="table"><th class="table" style="width:142px;"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Name</span></p></th><th class="table" style="width:106px;"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Type</span></p></th><th class="table"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Description</span></p></th></tr></thead><tbody><tr class="table"><td class="table" style="width:142px;"><p class="p_fortable"><span class="f_fortable">Condition_ID</span></p></td><td class="table" style="width:106px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Primary key. A unique configuration identifier required for more efficient retrieval of its information from the database. The key is assigned automatically upon export.</span></p></td></tr><tr class="table"><td class="table" style="width:142px;"><p class="p_fortable"><span class="f_fortable">Automation_ID</span></p></td><td class="table" style="width:106px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Identifier of the <a href="/en/docs/mt5/platform/components/backup_server/sql_export/sql_mt5_automations" class="topiclink">automation task</a> to which the condition belongs.</span></p></td></tr><tr class="table"><td class="table" style="width:142px;"><p class="p_fortable"><span class="f_fortable">Condition</span></p></td><td class="table" style="width:106px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Automation task triggering condition. Passed using the <a href="https://support.metaquotes.net/ru/docs/mt5/api/config_automation/imtconautocondition/imtconautocondition_enum#enconditions" target="_blank" class="weblink">EnConditions</a> enumeration.</span></p></td></tr><tr class="table"><td class="table" style="width:142px;"><p class="p_fortable"><span class="f_fortable">Rule</span></p></td><td class="table" style="width:106px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">A method for comparing a condition with the specified value. Passed using the <a href="https://support.metaquotes.net/ru/docs/mt5/api/config_automation/imtconautocondition/imtconautocondition_enum#enconditionrule" target="_blank" class="weblink">EnConditionRule</a> enumeration.</span></p></td></tr><tr class="table"><td class="table" style="width:142px;"><p class="p_fortable"><span class="f_fortable">ValueString</span></p></td><td class="table" style="width:106px;"><p class="p_fortable"><span class="f_fortable">String</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Condition value of type string.</span></p></td></tr><tr class="table"><td class="table" style="width:142px;"><p class="p_fortable"><span class="f_fortable">ValueInt</span></p></td><td class="table" style="width:106px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Condition value of type INT.</span></p></td></tr><tr class="table"><td class="table" style="width:142px;"><p class="p_fortable"><span class="f_fortable">ValueUInt</span></p></td><td class="table" style="width:106px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Condition value of type UINT.</span></p></td></tr><tr class="table"><td class="table" style="width:142px;"><p class="p_fortable"><span class="f_fortable">ValueFloat</span></p></td><td class="table" style="width:106px;"><p class="p_fortable"><span class="f_fortable">Float</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Condition value of type double.</span></p></td></tr><tr class="table"><td class="table" style="width:142px;"><p class="p_fortable"><span class="f_fortable">OrId</span></p></td><td class="table" style="width:106px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Identifier for the "OR" condition group. If several conditions of the same type have the same OrId, it means that they belong to the same "OR" condition block.</span></p></td></tr></tbody></table>
