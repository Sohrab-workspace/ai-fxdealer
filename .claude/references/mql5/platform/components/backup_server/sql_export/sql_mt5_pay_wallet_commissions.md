...
> Source: https://support.metaquotes.net/en/docs/mt5/platform/components/backup_server/sql_export/sql_mt5_pay_wallet_commissions
...
[MetaTrader 5](/en/docs/mt5)[Platform](/en/docs/mt5/platform)[Platform Components](/en/docs/mt5/platform/components)[Backup Server](/en/docs/mt5/platform/components/backup_server)[SQL Export](/en/docs/mt5/platform/components/backup_server/sql_export)mt5\_pay\_wallet\_commissions

# mt5\_pay\_wallet\_commissions

The table stores exported data on commission settings in [payment wallets](/en/docs/mt5/platform/administration/payments/payments_wallets#commissions). The table contains the following fields:

<table class="table" cellspacing="0" cellpadding="5" border="1"><thead><tr class="table"><th class="table" style="width:157px;"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Name</span></p></th><th class="table" style="width:110px;"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Type</span></p></th><th class="table"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Description</span></p></th></tr></thead><tbody><tr class="table"><td class="table" style="width:157px; height:18px;"><p class="p_fortable"><span class="f_fortable">Commission_ID</span></p></td><td class="table" style="width:110px; height:18px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Primary key. A unique identifier of the commission setting.</span></p></td></tr><tr class="table"><td class="table" style="width:157px; height:18px;"><p class="p_fortable"><span class="f_fortable">PaymentWallet_ID</span></p></td><td class="table" style="width:110px; height:18px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Primary key. A unique identifier of the wallet configuration.</span></p></td></tr><tr class="table"><td class="table" style="width:157px; height:18px;"><p class="p_fortable"><span class="f_fortable">Mode</span></p></td><td class="table" style="width:110px; height:18px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Commission calculation mode. Passed using the <a href="/en/docs/mt5/platform/components/backup_server/sql_export/sql_mt5_pay_wallets/pay_wallets_enum#encommissionmode" class="topiclink">EnCommissionMode</a> enumeration.</span></p></td></tr><tr class="table"><td class="table" style="width:157px; height:18px;"><p class="p_fortable"><span class="f_fortable">Entry</span></p></td><td class="table" style="width:110px; height:18px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Commission calculation mode depending on the transaction type. Passed using the <a href="/en/docs/mt5/platform/components/backup_server/sql_export/sql_mt5_pay_wallets/pay_wallets_enum#encommissionentry" class="topiclink">EnCommissionMode</a> enumeration.</span></p></td></tr><tr class="table"><td class="table" style="width:157px; height:18px;"><p class="p_fortable"><span class="f_fortable">Value</span></p></td><td class="table" style="width:110px; height:18px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Commission sum. Commission units depend on the commission Mode.</span></p></td></tr><tr class="table"><td class="table" style="width:157px; height:18px;"><p class="p_fortable"><span class="f_fortable">RangeFrom</span></p></td><td class="table" style="width:110px; height:18px;"><p class="p_fortable"><span class="f_fortable">Float</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Minimum transaction amount for which this commission will be charged.</span></p></td></tr><tr class="table"><td class="table" style="width:157px; height:18px;"><p class="p_fortable"><span class="f_fortable">RangeTo</span></p></td><td class="table" style="width:110px; height:18px;"><p class="p_fortable"><span class="f_fortable">Float</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Maximum transaction amount for which this commission will be charged.</span></p></td></tr><tr class="table"><td class="table" style="width:157px; height:18px;"><p class="p_fortable"><span class="f_fortable">Minimal</span></p></td><td class="table" style="width:110px; height:18px;"><p class="p_fortable"><span class="f_fortable">Float</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Minimum amount of commission charged. The value is specified in the group deposit currency.</span></p></td></tr><tr class="table"><td class="table" style="width:157px; height:18px;"><p class="p_fortable"><span class="f_fortable">Maximal</span></p></td><td class="table" style="width:110px; height:18px;"><p class="p_fortable"><span class="f_fortable">Float</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Maximum amount of commission charged. The value is specified in the group deposit currency.</span></p></td></tr><tr class="table"><td class="table" style="width:157px; height:18px;"><p class="p_fortable"><span class="f_fortable">Currency</span></p></td><td class="table" style="width:110px; height:18px;"><p class="p_fortable"><span class="f_fortable">String</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Commission calculation currency. Used for the <a href="/en/docs/mt5/platform/components/backup_server/sql_export/sql_mt5_pay_wallets/pay_wallets_enum#encommissionmode" class="topiclink">COMM_MONEY_SPECIFIED</a> mode.</span></p></td></tr></tbody></table>

[Enumerations](/en/docs/mt5/platform/components/backup_server/sql_export/sql_mt5_pay_wallets/pay_wallets_enum)
