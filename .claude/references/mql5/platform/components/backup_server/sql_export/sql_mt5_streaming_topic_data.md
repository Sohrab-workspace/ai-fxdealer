...
> Source: https://support.metaquotes.net/en/docs/mt5/platform/components/backup_server/sql_export/sql_mt5_streaming_topic_data
...
[MetaTrader 5](/en/docs/mt5)[Platform](/en/docs/mt5/platform)[Platform Components](/en/docs/mt5/platform/components)[Backup Server](/en/docs/mt5/platform/components/backup_server)[SQL Export](/en/docs/mt5/platform/components/backup_server/sql_export)mt5\_streaming\_topic\_data

# mt5\_streaming\_topic\_data

This table stores exported additional settings for data transmitted through the [streaming service](/en/docs/mt5/platform/administration/integration/integration_streaming/kafka_streaming#data). The table contains the following fields:

<table class="table" cellspacing="0" cellpadding="5" border="1"><thead><tr class="table"><th class="table" style="width:200px;"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Name</span></p></th><th class="table" style="width:110px;"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Type</span></p></th><th class="table"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Description</span></p></th></tr></thead><tbody><tr class="table"><td class="table" style="width:200px; height:18px;"><p class="p_fortable"><span class="f_fortable">Data_ID</span></p></td><td class="table" style="width:110px; height:18px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Primary key. A unique identifier of the setting.</span></p></td></tr><tr class="table"><td class="table" style="width:200px;"><p class="p_fortable"><span class="f_fortable">Topic_ID</span></p></td><td class="table" style="width:110px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Identifier of the topic associated with this setting.</span></p></td></tr><tr class="table"><td class="table" style="width:200px;"><p class="p_fortable"><span class="f_fortable">Type</span></p></td><td class="table" style="width:110px;"><p class="p_fortable"><span class="f_fortable">Integer</span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Type of transmitted data. Passed using the <a href="/en/docs/mt5/platform/components/backup_server/sql_export/sql_mt5_streamings/streamings_enum#endatatypes" class="topiclink">EnDataTypes</a> enumeration.</span></p></td></tr></tbody></table>
