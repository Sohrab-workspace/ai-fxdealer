...
> Source: https://support.metaquotes.net/en/docs/mt5/api/config_firewall/imtconfirewallsink/imtconfirewallsink_onfirewallsync
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Configuration Interfaces](/en/docs/mt5/api/reference_configurations)[Firewall](/en/docs/mt5/api/config_firewall)[IMTConFirewallSink](/en/docs/mt5/api/config_firewall/imtconfirewallsink)OnFirewallSync
