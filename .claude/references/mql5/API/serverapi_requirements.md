...
> Source: https://support.metaquotes.net/en/docs/mt5/api/serverapi_requirements
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Server API](/en/docs/mt5/api/serverapi)Requirements for Plugins
