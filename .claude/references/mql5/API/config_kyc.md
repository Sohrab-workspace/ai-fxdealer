...
> Source: https://support.metaquotes.net/en/docs/mt5/api/config_kyc
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Configuration Interfaces](/en/docs/mt5/api/reference_configurations)KYC
...
-   [IMTConKYC](/en/docs/mt5/api/config_kyc/imtconkyc) — methods for getting and editing KYC provider configurations.
-   [IMTConKYCCountry](/en/docs/mt5/api/config_kyc/imtconkyccountry) — methods for getting and editing country settings in KYC providers.
-   [IMTConKYCGroup](/en/docs/mt5/api/config_kyc/imtconkycgroup) — methods for getting and editing groups settings in KYC providers.
-   [IMTConKYCSink](/en/docs/mt5/api/config_kyc/imtconkycsink) — event handlers for changes in KYC provider configurations.

[OnVPSSync](/en/docs/mt5/api/config_vps/imtconvpssink/imtconvpssink_onvpssync)
