...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reference_bytestream
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Database Interfaces](/en/docs/mt5/api/reference_bases)Byte Stream

# Byte Stream

MetaTrader 5 API includes the special interface [IMTByteStream](/en/docs/mt5/api/reference_bytestream/imtbytestream), which provides for an easier operation with unformatted byte data streams. These data can be passed using [user functions](/en/docs/mt5/api/imtmanagerapi/imtmanagerapi_custom).
