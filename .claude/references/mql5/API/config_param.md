...
> Source: https://support.metaquotes.net/en/docs/mt5/api/config_param
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Configuration Interfaces](/en/docs/mt5/api/reference_configurations)Additional Parameters

# Configuration of Additional Parameters

The additional parameter configuration interfaces are auxiliary. They provide access to parameters of the "Name-Value" type. For example, such parameters are used for [configuring gateways](/en/docs/mt5/api/config_gateway):

![Example of "Name-Value" parameters in MetaTrader 5 Administrator](/en/docs/mt5/api/img/parameters_gateway.png "Example of "Name-Value" parameters in MetaTrader 5 Administrator")

Shown above:

-   [Parameter name](/en/docs/mt5/api/config_param/imtconparam/imtconparam_name).
-   [Parameter value](/en/docs/mt5/api/config_param/imtconparam/imtconparam_value).
