# Main Interface IMTServerAPI

> Source: https://support.metaquotes.net/en/docs/mt5/api/imtserverapi
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Server API](/en/docs/mt5/api/serverapi)Main API Interface

# Main Interface IMTServerAPI

IMTServerAPI is the main interface of the MetaTrader 5 Server API. It contains almost all methods of managing the trading platform:
