# Protocol Implementation in .NET

> Source: https://support.metaquotes.net/en/docs/mt5/api/webapi_main/net
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Web API](/en/docs/mt5/api/webapi)[Manager Interface (Rest API)](/en/docs/mt5/api/webapi_main).NET Implementation of Protocol

# Protocol Implementation in .NET

The MetaTrader 5 SDK package includes an example of [.NET implementation of the Web API protocol](/en/docs/mt5/api/webapi_main/net/net_mtwebapi). The implementation is available in the form of a ready to use DLLs MetaQuotes.MT5WebAPI.dll. It is are available in the \[MetaTrader 5 SDK installation directory\]\\Libs\\.

Include the library in your project to use the functions. It is suitable for both 32 and 64 bit applications. The full description of these function is provided under the [MT5WebAPI Class](/en/docs/mt5/api/webapi_main/net/net_mtwebapi) section.

In addition, the package includes [.NET source code for a ready to use website](/en/docs/mt5/api/webapi_main/net/net_webtrader) demonstrating the Web API capabilities. Example is available as a Microsoft Visual Studio project. It is available in the \[MetaTrader 5 SDK installation directory\]\\Examples\\Web\\WebTrader\\.

[Working with Example](/en/docs/mt5/api/webapi_main/php/php_examples/php_extension/php_extension_working)
