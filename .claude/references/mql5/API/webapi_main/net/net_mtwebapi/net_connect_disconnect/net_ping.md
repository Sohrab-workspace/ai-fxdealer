...
> Source: https://support.metaquotes.net/en/docs/mt5/api/webapi_main/net/net_mtwebapi/net_connect_disconnect/net_ping
                ...
                -   [.NET Implementation of Protocol](/en/docs/mt5/api/webapi_main/net)
                    -   [MT5WebAPI Class](/en/docs/mt5/api/webapi_main/net/net_mtwebapi)
                        ...
                        -   [Connect/Disconnect](/en/docs/mt5/api/webapi_main/net/net_mtwebapi/net_connect_disconnect)
                            -   [Connect](/en/docs/mt5/api/webapi_main/net/net_mtwebapi/net_connect_disconnect/net_connect)
                            -   [Disconnect](/en/docs/mt5/api/webapi_main/net/net_mtwebapi/net_connect_disconnect/net_disconnect)
                            -   [IsConnected](/en/docs/mt5/api/webapi_main/net/net_mtwebapi/net_connect_disconnect/net_isconnected)
                            -   [Ping](/en/docs/mt5/api/webapi_main/net/net_mtwebapi/net_connect_disconnect/net_ping)
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Web API](/en/docs/mt5/api/webapi)[Manager Interface (Rest API)](/en/docs/mt5/api/webapi_main)[.NET Implementation of Protocol](/en/docs/mt5/api/webapi_main/net)[MT5WebAPI Class](/en/docs/mt5/api/webapi_main/net/net_mtwebapi)[Connect/Disconnect](/en/docs/mt5/api/webapi_main/net/net_mtwebapi/net_connect_disconnect)Ping
