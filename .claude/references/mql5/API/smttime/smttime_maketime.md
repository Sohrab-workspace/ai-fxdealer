...
> Source: https://support.metaquotes.net/en/docs/mt5/api/smttime/smttime_maketime
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Tools](/en/docs/mt5/api/reference_tools)[SMTTime](/en/docs/mt5/api/smttime)MakeTime

# SMTTime::MakeTime

Form a date in the Unix time format from a passed tm structure.

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">static&nbsp;INT64&nbsp;&nbsp;</span><span class="f_Functions">SMTTime::MakeTime</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">tm</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Param">*ttm</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;A&nbsp;prepared&nbsp;tm&nbsp;structure</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>
