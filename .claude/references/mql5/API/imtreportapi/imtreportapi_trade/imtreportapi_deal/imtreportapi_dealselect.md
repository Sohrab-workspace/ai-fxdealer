...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtreportapi/imtreportapi_trade/imtreportapi_deal/imtreportapi_dealselect
        ...
        -   [Report API](/en/docs/mt5/api/reportapi)
            ...
            -   [Main Interface of Reports](/en/docs/mt5/api/imtreportapi)
                ...
                -   [Trade Databases](/en/docs/mt5/api/imtreportapi/imtreportapi_trade)
                    -   [Orders](/en/docs/mt5/api/imtreportapi/imtreportapi_trade/imtreportapi_order)
                    -   [Deals](/en/docs/mt5/api/imtreportapi/imtreportapi_trade/imtreportapi_deal)
                        -   [DealCreate](/en/docs/mt5/api/imtreportapi/imtreportapi_trade/imtreportapi_deal/imtreportapi_dealcreate)
                        -   [DealCreateArray](/en/docs/mt5/api/imtreportapi/imtreportapi_trade/imtreportapi_deal/imtreportapi_dealcreatearray)
                        -   [DealGet](/en/docs/mt5/api/imtreportapi/imtreportapi_trade/imtreportapi_deal/imtreportapi_dealget)
                        -   [DealSelect](/en/docs/mt5/api/imtreportapi/imtreportapi_trade/imtreportapi_deal/imtreportapi_dealselect)
                    -   [Positions](/en/docs/mt5/api/imtreportapi/imtreportapi_trade/imtreportapi_position)
                    -   [Trading Data](/en/docs/mt5/api/imtreportapi/imtreportapi_trade/imtreportapi_tradeinfo)
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Main Interface of Reports](/en/docs/mt5/api/imtreportapi)[Trade Databases](/en/docs/mt5/api/imtreportapi/imtreportapi_trade)[Deals](/en/docs/mt5/api/imtreportapi/imtreportapi_trade/imtreportapi_deal)DealSelect

# IMTReportAPI::DealSelect

Request deals from a database according to specified criteria.

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">MTAPIRES&nbsp;&nbsp;</span><span class="f_Functions">IMTReportAPI::UserSelect</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">const&nbsp;IMTDatasetRequest*</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Param">request</span><span class="f_CodeExample">,&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Request&nbsp;description</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">IMTDataset*</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Param">dataset</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Data&nbsp;set</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>

Parameters

request

\[in\]  The [IMTDatasetRequest](/en/docs/mt5/api/reportapi_dataset/imtdatasetrequest) object, which describes deal request criteria.

dataset

\[out\]  The [IMTDataset](/en/docs/mt5/api/reportapi_dataset/imtdataset) object to which deals received from the data base in accordance with the request will be added. The object must be previously created using the [IMTReportAPI::DatasetAppend](/en/docs/mt5/api/imtreportapi/imtreportapi_dataset/imtreportapi_datasetappend) method.
...
The method allows requesting data related to any accounts available on the trade server and not only to the accounts which are accessible to the manager generating the report ([IMTConManager::GroupAdd](/en/docs/mt5/api/config_manager/imtconmanager/imtconmanager_groupadd)). If the filter by logins is not explicitly specified ([IMTDatasetField::FIELD\_DEAL\_LOGIN](/en/docs/mt5/api/reportapi_dataset/imtdatasetfield/imtdatasetfield_enum#enfieldid)), the default method will retrieve only data related to the accounts which the manager has access to.
