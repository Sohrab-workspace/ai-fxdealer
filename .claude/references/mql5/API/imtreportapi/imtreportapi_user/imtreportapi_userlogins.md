...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtreportapi/imtreportapi_user/imtreportapi_userlogins
...
The UserLogins function allocates and fills an array of logins that belong to the passed group, a pointer to the passed block is placed to the logins parameter. After using, the array placed in the logins variable must be released using the [IMTReportAPI::Free](/en/docs/mt5/api/imtreportapi/imtreportapi_common/imtreportapi_free) method.
