...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtreportapi/imtreportapi_user/imtreportapi_usercreate
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Main Interface of Reports](/en/docs/mt5/api/imtreportapi)[Users](/en/docs/mt5/api/imtreportapi/imtreportapi_user)UserCreate

# IMTReportAPI::UserCreate

Create an object of a client record.

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">IMTUser*&nbsp;&nbsp;</span><span class="f_Functions">IMTReportAPI::UserCreate</span><span class="f_CodeExample">()</span></p></td></tr></tbody></table>
