...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtreportapi/imtreportapi_user/imtreportapi_userselect
        ...
        -   [Report API](/en/docs/mt5/api/reportapi)
            ...
            -   [Main Interface of Reports](/en/docs/mt5/api/imtreportapi)
                ...
                -   [Users](/en/docs/mt5/api/imtreportapi/imtreportapi_user)
                    -   [UserCreate](/en/docs/mt5/api/imtreportapi/imtreportapi_user/imtreportapi_usercreate)
                    -   [UserCreateAccount](/en/docs/mt5/api/imtreportapi/imtreportapi_user/imtreportapi_usercreateaccount)
                    -   [UserGet](/en/docs/mt5/api/imtreportapi/imtreportapi_user/imtreportapi_userget)
                    -   [UserGetLight](/en/docs/mt5/api/imtreportapi/imtreportapi_user/imtreportapi_usergetlight)
                    -   [UserLogins](/en/docs/mt5/api/imtreportapi/imtreportapi_user/imtreportapi_userlogins)
                    -   [UserAccountGet](/en/docs/mt5/api/imtreportapi/imtreportapi_user/imtreportapi_useraccountget)
                    -   [UserSelect](/en/docs/mt5/api/imtreportapi/imtreportapi_user/imtreportapi_userselect)
                    -   [UserAccountSelect](/en/docs/mt5/api/imtreportapi/imtreportapi_user/imtreportapi_useraccountselect)
                    -   [ClientSelect](/en/docs/mt5/api/imtreportapi/imtreportapi_user/imtreportapi_clientselect)
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Main Interface of Reports](/en/docs/mt5/api/imtreportapi)[Users](/en/docs/mt5/api/imtreportapi/imtreportapi_user)UserSelect
