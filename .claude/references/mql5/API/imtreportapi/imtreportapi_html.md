# HTML Reports Functions

> Source: https://support.metaquotes.net/en/docs/mt5/api/imtreportapi/imtreportapi_html
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Main Interface of Reports](/en/docs/mt5/api/imtreportapi)HTML Reports

# HTML Reports Functions

This type of reports is generated in HTML code and sent to a manager terminal when an appropriate request arrives. Except the data itself marked by HTML language, a report may contain various charts. The functions of working with HTML code and charts are described in separate subsections:

-   [HTML Functions](/en/docs/mt5/api/imtreportapi/imtreportapi_html/imtreportapi_html_management)
-   [Charts Functions](/en/docs/mt5/api/imtreportapi/imtreportapi_html/imtreportapi_chart_management)
