...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtreportapi/imtreportapi_trade
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Main Interface of Reports](/en/docs/mt5/api/imtreportapi)Trade Databases

# Trade Database Functions

The functions described in this section allow to get information from the MetaTrader 5 platform trading base. Description consists of the following topics:
