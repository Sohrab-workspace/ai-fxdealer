...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtreportapi/imtreportapi_table/imtreportapi_table_column/imtreportapi_tablecolumncreate
            ...
            -   [Main Interface of Reports](/en/docs/mt5/api/imtreportapi)
                ...
                -   [Tabular Reports](/en/docs/mt5/api/imtreportapi/imtreportapi_table)
                    -   [Columns](/en/docs/mt5/api/imtreportapi/imtreportapi_table/imtreportapi_table_column)
                        -   [TableColumnCreate](/en/docs/mt5/api/imtreportapi/imtreportapi_table/imtreportapi_table_column/imtreportapi_tablecolumncreate)
                        -   [TableColumnClear](/en/docs/mt5/api/imtreportapi/imtreportapi_table/imtreportapi_table_column/imtreportapi_tablecolumnclear)
                        -   [TableColumnAdd](/en/docs/mt5/api/imtreportapi/imtreportapi_table/imtreportapi_table_column/imtreportapi_tablecolumnadd)
                        -   [TableColumnDelete](/en/docs/mt5/api/imtreportapi/imtreportapi_table/imtreportapi_table_column/imtreportapi_tablecolumndelete)
                        -   [TableColumnTotal](/en/docs/mt5/api/imtreportapi/imtreportapi_table/imtreportapi_table_column/imtreportapi_tablecolumntotal)
                        -   [TableColumnSize](/en/docs/mt5/api/imtreportapi/imtreportapi_table/imtreportapi_table_column/imtreportapi_tablecolumnsize)
                        -   [TableColumnNext](/en/docs/mt5/api/imtreportapi/imtreportapi_table/imtreportapi_table_column/imtreportapi_tablecolumnnext)
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Main Interface of Reports](/en/docs/mt5/api/imtreportapi)[Tabular Reports](/en/docs/mt5/api/imtreportapi/imtreportapi_table)[Columns](/en/docs/mt5/api/imtreportapi/imtreportapi_table/imtreportapi_table_column)TableColumnCreate

# IMTReportAPI::TableColumnCreate

A column object creation.

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">IMTDatasetColumn*&nbsp;&nbsp;</span><span class="f_Functions">IMTReportAPI::TableColumnCreate</span><span class="f_CodeExample">()</span></p></td></tr></tbody></table>

Return Value

It returns a pointer to the created object that implements the [IMTDatasetColumn](/en/docs/mt5/api/reportapi_dataset/imtdatasetcolumn) interface. In case of failure, it returns NULL.

Note

The created object must be destroyed by calling the [IMTDatasetColumn::Release](/en/docs/mt5/api/reportapi_dataset/imtdatasetcolumn/imtdatasetcolumn_release) method of this object.
