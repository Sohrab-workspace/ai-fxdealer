...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtreportapi/imtreportapi_table/imtreportapi_table_row/imtreportapi_tablerowwrite
            ...
            -   [Main Interface of Reports](/en/docs/mt5/api/imtreportapi)
                ...
                -   [Tabular Reports](/en/docs/mt5/api/imtreportapi/imtreportapi_table)
                    ...
                    -   [Rows](/en/docs/mt5/api/imtreportapi/imtreportapi_table/imtreportapi_table_row)
                        -   [TableRowClear](/en/docs/mt5/api/imtreportapi/imtreportapi_table/imtreportapi_table_row/imtreportapi_tablerowclear)
                        -   [TableRowWrite](/en/docs/mt5/api/imtreportapi/imtreportapi_table/imtreportapi_table_row/imtreportapi_tablerowwrite)
                        -   [TableRowTotal](/en/docs/mt5/api/imtreportapi/imtreportapi_table/imtreportapi_table_row/imtreportapi_tablerowtotal)
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Main Interface of Reports](/en/docs/mt5/api/imtreportapi)[Tabular Reports](/en/docs/mt5/api/imtreportapi/imtreportapi_table)[Rows](/en/docs/mt5/api/imtreportapi/imtreportapi_table/imtreportapi_table_row)TableRowWrite

# IMTReportAPI::TableRowWrite

Add (output) one record to a table.

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">MTAPIRES&nbsp;&nbsp;</span><span class="f_Functions">IMTReportAPI::TableRowWrite</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">const&nbsp;void</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Param">*data</span><span class="f_CodeExample">,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;a&nbsp;pointer&nbsp;to&nbsp;the&nbsp;data</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">const&nbsp;UINT</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Param">size</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Data&nbsp;size</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>
...
\[in\]  Data size. The size of the submitted data is checked for its compliance with the [IMTReportAPI::TableColumnSize](/en/docs/mt5/api/imtreportapi/imtreportapi_table/imtreportapi_table_column/imtreportapi_tablecolumnsize) value.
...
Maximum allowed size of a tabular report is 4GB. If this limit is reached, IMTReportAPI::TableRowWrite will return error [MT\_RET\_REPORT\_LIMIT\_REPORT](/en/docs/mt5/api/retcodes_reports).
