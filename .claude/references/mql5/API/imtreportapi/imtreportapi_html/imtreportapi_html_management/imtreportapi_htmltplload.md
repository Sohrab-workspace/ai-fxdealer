...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtreportapi/imtreportapi_html/imtreportapi_html_management/imtreportapi_htmltplload
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Main Interface of Reports](/en/docs/mt5/api/imtreportapi)[HTML Reports](/en/docs/mt5/api/imtreportapi/imtreportapi_html)[HTML](/en/docs/mt5/api/imtreportapi/imtreportapi_html/imtreportapi_html_management)HtmlTplLoad

# IMTReportAPI::HtmlTplLoad

Loading a template from the submitted line.

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">MTAPIRES&nbsp;&nbsp;</span><span class="f_Functions">IMTReportAPI::HtmlTplLoad</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">LPCWSTR</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Param">templstr</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Template&nbsp;line</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>
...
After the loading is complete the template is ready for work at once using the [IMTReportAPI::HtmlTplNext](/en/docs/mt5/api/imtreportapi/imtreportapi_html/imtreportapi_html_management/imtreportapi_htmltplnext) method.
