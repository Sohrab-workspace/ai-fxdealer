...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtreportapi/imtreportapi_html/imtreportapi_html_management/imtreportapi_htmlwritesafe
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Main Interface of Reports](/en/docs/mt5/api/imtreportapi)[HTML Reports](/en/docs/mt5/api/imtreportapi/imtreportapi_html)[HTML](/en/docs/mt5/api/imtreportapi/imtreportapi_html/imtreportapi_html_management)HtmlWriteSafe

# IMTReportAPI::HtmlWriteSafe

Output of a line in HTML with HTML service symbols screening.

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">MTAPIRES&nbsp;&nbsp;</span><span class="f_Functions">IMTReportAPI::HtmlWriteSafe</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">LPCWSTR</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Param">html</span><span class="f_CodeExample">,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Output&nbsp;line</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">const&nbsp;UINT</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Param">flags</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Output&nbsp;flags</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>
...
\[in\]  Additional output flags transferred using the [IMTReportAPI::EnHtmlSafeFlags](/en/docs/mt5/api/imtreportapi/imtreportapi_enum#enhtmlsafeflags) enumeration.
...
Maximum allowed size of an HTML report is 128MB. If this limit is reached, IMTReportAPI::HtmlWriteSafe will return error [MT\_RET\_REPORT\_LIMIT\_REPORT](/en/docs/mt5/api/retcodes_reports).
