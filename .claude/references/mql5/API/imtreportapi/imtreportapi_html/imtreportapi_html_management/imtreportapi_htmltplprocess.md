...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtreportapi/imtreportapi_html/imtreportapi_html_management/imtreportapi_htmltplprocess
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Main Interface of Reports](/en/docs/mt5/api/imtreportapi)[HTML Reports](/en/docs/mt5/api/imtreportapi/imtreportapi_html)[HTML](/en/docs/mt5/api/imtreportapi/imtreportapi_html/imtreportapi_html_management)HtmlTplProcess

# IMTReportAPI::HtmlTplProcess

Set the feature of the processing of all tags inside the current macros (predetermined tag).

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">MTAPIRES&nbsp;&nbsp;</span><span class="f_Functions">IMTReportAPI::HtmlTplProcess</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">const&nbsp;UINT</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Param">flags</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;processing&nbsp;flag</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>

Parameters

flags

\[in\]  Flag of a macros processing necessity. Transfered using the [IMTReportAPI::EnTplProcessFlags](/en/docs/mt5/api/imtreportapi/imtreportapi_enum#entplprocessflags) enumeration.
...
In fact, this method dermines the necessity of processing of the macros received by the [IMTReportAPI::HtmlTplNext](/en/docs/mt5/api/imtreportapi/imtreportapi_html/imtreportapi_html_management/imtreportapi_htmltplnext) method.
