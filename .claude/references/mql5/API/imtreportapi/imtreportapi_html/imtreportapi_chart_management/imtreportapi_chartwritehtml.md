...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtreportapi/imtreportapi_html/imtreportapi_chart_management/imtreportapi_chartwritehtml
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Main Interface of Reports](/en/docs/mt5/api/imtreportapi)[HTML Reports](/en/docs/mt5/api/imtreportapi/imtreportapi_html)[Charts](/en/docs/mt5/api/imtreportapi/imtreportapi_html/imtreportapi_chart_management)ChartWriteHtml

# IMTReportAPI::ChartWriteHtml

Output of a chart to an HTML report.

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">MTAPIRES&nbsp;&nbsp;</span><span class="f_Functions">IMTReportAPI::ChartWriteHtml</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">const&nbsp;IMTReportChart*</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Param">chart</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;the&nbsp;chart&nbsp;object</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>

Parameters

chart

\[in\] [The chart object](/en/docs/mt5/api/reportapi_auxiliary/imtreportchart).
...
This method can be used only for HTML reports ([MTReportInfo::TYPE\_HTML)](/en/docs/mt5/api/mtreportinfo#entypes).
