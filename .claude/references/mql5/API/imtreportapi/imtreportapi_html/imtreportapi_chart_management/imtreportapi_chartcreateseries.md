...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtreportapi/imtreportapi_html/imtreportapi_chart_management/imtreportapi_chartcreateseries
            ...
            -   [Main Interface of Reports](/en/docs/mt5/api/imtreportapi)
                ...
                -   [HTML Reports](/en/docs/mt5/api/imtreportapi/imtreportapi_html)
                    ...
                    -   [Charts](/en/docs/mt5/api/imtreportapi/imtreportapi_html/imtreportapi_chart_management)
                        -   [ChartCreate](/en/docs/mt5/api/imtreportapi/imtreportapi_html/imtreportapi_chart_management/imtreportapi_chartcreate)
                        -   [ChartCreateSeries](/en/docs/mt5/api/imtreportapi/imtreportapi_html/imtreportapi_chart_management/imtreportapi_chartcreateseries)
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Main Interface of Reports](/en/docs/mt5/api/imtreportapi)[HTML Reports](/en/docs/mt5/api/imtreportapi/imtreportapi_html)[Charts](/en/docs/mt5/api/imtreportapi/imtreportapi_html/imtreportapi_chart_management)ChartCreateSeries

# IMTReportAPI::ChartCreateSeries

Create a data series object for a chart.

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">IMTReportSeries*&nbsp;&nbsp;</span><span class="f_Functions">IMTReportAPI::ChartCreateSeries</span><span class="f_CodeExample">()</span></p></td></tr></tbody></table>

Return Value

It returns a pointer to the created object that implements the [IMTReportSeries](/en/docs/mt5/api/reportapi_auxiliary/imtreportseries) interface. In case of failure, it returns NULL.

Note

The created object must be destroyed by calling the [IMTReporSeries::Release](/en/docs/mt5/api/reportapi_auxiliary/imtreportseries/imtreportseries_release) method of this object.
