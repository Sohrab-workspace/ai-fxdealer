...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtreportapi/imtreportapi_price/imtreportapi_charthistoryget
...
After using, the bars array must be released using the [IMTReportAPI::Free](/en/docs/mt5/api/imtreportapi/imtreportapi_common/imtreportapi_free) method.
