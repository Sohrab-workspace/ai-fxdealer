...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtreportapi/imtreportapi_price/imtreportapi_tickhistoryget
...
After being used, the array of structures [MTTickShort](/en/docs/mt5/api/mttickshort) must be released using the [IMTReportAPI::Free](/en/docs/mt5/api/imtreportapi/imtreportapi_common/imtreportapi_free) method.
