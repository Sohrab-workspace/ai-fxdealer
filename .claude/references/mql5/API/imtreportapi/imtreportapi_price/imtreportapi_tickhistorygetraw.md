...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtreportapi/imtreportapi_price/imtreportapi_tickhistorygetraw
        ...
        -   [Report API](/en/docs/mt5/api/reportapi)
            ...
            -   [Main Interface of Reports](/en/docs/mt5/api/imtreportapi)
                ...
                -   [Price Data](/en/docs/mt5/api/imtreportapi/imtreportapi_price)
                    -   [TickGet](/en/docs/mt5/api/imtreportapi/imtreportapi_price/imtreportapi_tickget)
                    -   [TickLast](/en/docs/mt5/api/imtreportapi/imtreportapi_price/imtreportapi_ticklast)
                    -   [TickStat](/en/docs/mt5/api/imtreportapi/imtreportapi_price/imtreportapi_tickstat)
                    -   [TickHistoryGetRaw](/en/docs/mt5/api/imtreportapi/imtreportapi_price/imtreportapi_tickhistorygetraw)
                    -   [TickHistoryGet](/en/docs/mt5/api/imtreportapi/imtreportapi_price/imtreportapi_tickhistoryget)
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Main Interface of Reports](/en/docs/mt5/api/imtreportapi)[Price Data](/en/docs/mt5/api/imtreportapi/imtreportapi_price)TickHistoryGetRaw
...
If the option of storing raw prices is disabled in symbol settings ([IMTConSymbol::TICK\_COLLECTRAW](/en/docs/mt5/api/config_symbol/imtconsymbol/imtconsymbol_enum#entickflags)), the method will always return 0 quotes.

After being used, the array of structures [MTTickShort](/en/docs/mt5/api/mttickshort) must be released using the [IMTServerAPI::Free](/en/docs/mt5/api/imtreportapi/imtreportapi_common/imtreportapi_free) method.
