...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtreportapi/imtreportapi_common/imtreportapi_loggerrequest
        ...
        -   [Report API](/en/docs/mt5/api/reportapi)
            ...
            -   [Main Interface of Reports](/en/docs/mt5/api/imtreportapi)
                ...
                -   [Common Functions](/en/docs/mt5/api/imtreportapi/imtreportapi_common)
                    -   [Allocate](/en/docs/mt5/api/imtreportapi/imtreportapi_common/imtreportapi_allocate)
                    -   [Free](/en/docs/mt5/api/imtreportapi/imtreportapi_common/imtreportapi_free)
                    -   [LoggerRequest](/en/docs/mt5/api/imtreportapi/imtreportapi_common/imtreportapi_loggerrequest)
                    -   [LoggerFlush](/en/docs/mt5/api/imtreportapi/imtreportapi_common/imtreportapi_loggerflush)
                    -   [LoggerOut](/en/docs/mt5/api/imtreportapi/imtreportapi_common/imtreportapi_loggerout)
                    -   [LoggerOutString](/en/docs/mt5/api/imtreportapi/imtreportapi_common/imtreportapi_loggeroutstring)
                    -   [IsStopeed](/en/docs/mt5/api/imtreportapi/imtreportapi_common/imtreportapi_isstopped)
                    -   [Clear](/en/docs/mt5/api/imtreportapi/imtreportapi_common/imtreportapi_clear)
                    -   [LicenseCheck](/en/docs/mt5/api/imtreportapi/imtreportapi_common/imtreportapi_licensecheck)
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Main Interface of Reports](/en/docs/mt5/api/imtreportapi)[Common Functions](/en/docs/mt5/api/imtreportapi/imtreportapi_common)LoggerRequest

# IMTReportAPI::LoggerRequest

Request the journal of the trade server where the module is running.

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">virtual&nbsp;MTAPIRES&nbsp;&nbsp;</span><span class="f_Functions">IMTReportAPI::LoggerServerRequest</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">const&nbsp;UINT</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Param">mode</span><span class="f_CodeExample">,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Request&nbsp;mode</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">const&nbsp;UINT</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Param">type</span><span class="f_CodeExample">,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Event&nbsp;type</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">const&nbsp;INT64</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Param">from</span><span class="f_CodeExample">,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Start&nbsp;date</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">const&nbsp;INT64</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Param">to</span><span class="f_CodeExample">,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;End&nbsp;date</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">LPCWSTR</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Param">filter</span><span class="f_CodeExample">,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Keyword</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">MTLogRecord*&amp;</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Param">records</span><span class="f_CodeExample">,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Array&nbsp;of&nbsp;entries</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">UINT&amp;</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Param">records_total</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;The&nbsp;number&nbsp;of&nbsp;received&nbsp;entries</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>

Parameters

mode

\[in\]  The mode of journal requesting. To pass the mode, the [EnMTLogRequestMode](/en/docs/mt5/api/journal#enmtlogrequestmode) enumeration is used.

type

\[in\]  Type of events that should be requested from the server journal. To pass the type of events, the [EnMTLogType](/en/docs/mt5/api/journal#enmtlogtype) enumeration is used.
...
After using, the records array must be released using the [IMTReportAPI::Free](/en/docs/mt5/api/imtreportapi/imtreportapi_common/imtreportapi_free) method.
