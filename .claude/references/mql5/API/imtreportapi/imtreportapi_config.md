...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtreportapi/imtreportapi_config
        ...
        -   [Report API](/en/docs/mt5/api/reportapi)
            ...
            -   [Main Interface of Reports](/en/docs/mt5/api/imtreportapi)
                ...
                -   [Configuration Databases](/en/docs/mt5/api/imtreportapi/imtreportapi_config)
                    -   [Reports](/en/docs/mt5/api/imtreportapi/imtreportapi_config/imtreportapi_config_report)
                    -   [Common](/en/docs/mt5/api/imtreportapi/imtreportapi_config/imtreportapi_config_common)
                    -   [Network](/en/docs/mt5/api/imtreportapi/imtreportapi_config/imtreportapi_config_network)
                    -   [Plugins](/en/docs/mt5/api/imtreportapi/imtreportapi_config/imtreportapi_config_plugin)
                    -   [Data Feeds](/en/docs/mt5/api/imtreportapi/imtreportapi_config/imtreportapi_config_datafeed)
                    -   [Time](/en/docs/mt5/api/imtreportapi/imtreportapi_config/imtreportapi_config_time)
                    -   [Holidays](/en/docs/mt5/api/imtreportapi/imtreportapi_config/imtreportapi_config_holiday)
                    -   [Groups](/en/docs/mt5/api/imtreportapi/imtreportapi_config/imtreportapi_config_group)
                    -   [Symbols](/en/docs/mt5/api/imtreportapi/imtreportapi_config/imtreportapi_config_symbol)
                    -   [Managers](/en/docs/mt5/api/imtreportapi/imtreportapi_config/imtreportapi_config_manager)
                    -   [Gateways](/en/docs/mt5/api/imtreportapi/imtreportapi_config/imtreportapi_config_gateway)
                    -   [Subscriptions](/en/docs/mt5/api/imtreportapi/imtreportapi_config/imtreportapi_config_subscription)
                    -   [Funds and ETF](/en/docs/mt5/api/imtreportapi/imtreportapi_config/imtreportapi_config_fund)
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Main Interface of Reports](/en/docs/mt5/api/imtreportapi)Configuration Databases

# Configuration Databases

The functions described in this section allow to get the current platform settings. The functions of working with configuration bases are described in the following sections:

-   [Report](/en/docs/mt5/api/imtreportapi/imtreportapi_config/imtreportapi_config_report)
-   [Common](/en/docs/mt5/api/imtreportapi/imtreportapi_config/imtreportapi_config_common)
-   [Network](/en/docs/mt5/api/imtreportapi/imtreportapi_config/imtreportapi_config_network)
-   [Plugins](/en/docs/mt5/api/imtreportapi/imtreportapi_config/imtreportapi_config_plugin)
-   [Data Feeds](/en/docs/mt5/api/imtreportapi/imtreportapi_config/imtreportapi_config_datafeed)
