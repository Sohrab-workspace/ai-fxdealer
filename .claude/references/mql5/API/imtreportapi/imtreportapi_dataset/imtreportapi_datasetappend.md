...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtreportapi/imtreportapi_dataset/imtreportapi_datasetappend
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Main Interface of Reports](/en/docs/mt5/api/imtreportapi)[Dataset](/en/docs/mt5/api/imtreportapi/imtreportapi_dataset)DatasetAppend

# IMTReportAPI::DatasetAppend

Add a data set to a dashboard.

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">IMTDataset*&nbsp;&nbsp;</span><span class="f_Functions">IMTReportAPI::DatasetAppend</span><span class="f_CodeExample">()</span></p></td></tr></tbody></table>

Return Value

Pointer to the created [IMTDataset](/en/docs/mt5/api/reportapi_dataset/imtdataset) tabular data set object.

Note

The method creates a data set bound to the dashboard and returns a pointer to it. To display a data set, it should be bound to the widget using the [IMTReportDashboardWidget::Data](/en/docs/mt5/api/reportapi_dashboard/imtreportdashboardwidget/imtreportdashboardwidget_data) method. The widget in turn should be created by the [IMTReportAPI::DashboardWidgetAppend](/en/docs/mt5/api/imtreportapi/imtreportapi_dashboard/imtreportapi_dashboardwidgetappend) method.
