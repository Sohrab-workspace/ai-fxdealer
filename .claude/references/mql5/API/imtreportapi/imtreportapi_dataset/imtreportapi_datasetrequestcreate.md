...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtreportapi/imtreportapi_dataset/imtreportapi_datasetrequestcreate
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Main Interface of Reports](/en/docs/mt5/api/imtreportapi)[Dataset](/en/docs/mt5/api/imtreportapi/imtreportapi_dataset)DatasetRequestCreate

# IMTReportAPI::DatasetRequestCreate

Create a data request object.

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">IMTDatasetRequest*&nbsp;&nbsp;</span><span class="f_Functions">IMTReportAPI::DatasetRequestCreate</span><span class="f_CodeExample">()</span></p></td></tr></tbody></table>

Return Value

Returns a pointer to the created object which implements the [IMTDatasetRequest](/en/docs/mt5/api/reportapi_dataset/imtdatasetrequest) interface. In case of failure, it returns NULL.

Note

The created object must be destroyed by calling the [IMTDatasetRequest::Release](/en/docs/mt5/api/reportapi_dataset/imtdatasetrequest/imtdatasetrequest_release) method of this object.

See [the separate section](/en/docs/mt5/api/reportapi_dataset#request) for more details.
