...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reference_subscription
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Database Interfaces](/en/docs/mt5/api/reference_bases)Subscriptions
...
-   [IMTSubscription](/en/docs/mt5/api/reference_subscription/imtsubscription) — an interface for accessing trader's subscription parameters.
-   [IMTSubscriptionArray](/en/docs/mt5/api/reference_subscription/imtsubscriptionarray) — an interface for convenient operations with arrays of subscriptions.
-   [IMTSubscriptionHistory](/en/docs/mt5/api/reference_subscription/imtsubscriptionhistory) — an interface for accessing [subscription action parameters](https://support.metaquotes.net/en/docs/mt5/platform/administration/subscriptions/subscriptions_control#history).
-   [IMTSubscriptionHistoryArray](/en/docs/mt5/api/reference_subscription/imtsubscriptionhistoryarray) — an interface for convenient operations with arrays of subscription actions.
-   [IMTSubscriptionSink](/en/docs/mt5/api/reference_subscription/imtsubscriptionsink) — an interface for handling events related to changes in the subscriptions database.
-   [IMTSubscriptionHistorySink](/en/docs/mt5/api/reference_subscription/imtsubscriptionhistorysink) — an interface for handling events related to changes in the database of subscription actions.
