...
> Source: https://support.metaquotes.net/en/docs/mt5/api/config_report/imtconreportsink/imtconreportsink_onreportdelete
        ...
        -   [Configuration Interfaces](/en/docs/mt5/api/reference_configurations)
            ...
            -   [Reports](/en/docs/mt5/api/config_report)
                ...
                -   [IMTConReportSink](/en/docs/mt5/api/config_report/imtconreportsink)
                    -   [OnReportAdd](/en/docs/mt5/api/config_report/imtconreportsink/imtconreportsink_onreportadd)
                    -   [OnReportUpdate](/en/docs/mt5/api/config_report/imtconreportsink/imtconreportsink_onreportupdate)
                    -   [OnReportDelete](/en/docs/mt5/api/config_report/imtconreportsink/imtconreportsink_onreportdelete)
                    -   [OnReportSync](/en/docs/mt5/api/config_report/imtconreportsink/imtconreportsink_onreportsync)
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Configuration Interfaces](/en/docs/mt5/api/reference_configurations)[Reports](/en/docs/mt5/api/config_report)[IMTConReportSink](/en/docs/mt5/api/config_report/imtconreportsink)OnReportDelete
...
<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">virtual&nbsp;void&nbsp;&nbsp;</span><span class="f_Functions">IMTConReportSink::OnReportDelete</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">const&nbsp;IMTConReport*</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Param">report</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;A&nbsp;pointer&nbsp;to&nbsp;the&nbsp;configuration&nbsp;object</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>

.NET (Gateway/Manager API)

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">virtual&nbsp;void&nbsp;&nbsp;</span><span class="f_Functions">CIMTConReportSink.OnReportDelete</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">CIMTConReport</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Param">report</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Configuration&nbsp;object</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>
