...
> Source: https://support.metaquotes.net/en/docs/mt5/api/cmtthread/cmtthread_terminate
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Tools](/en/docs/mt5/api/reference_tools)[CMTThread](/en/docs/mt5/api/cmtthread)Terminate

# CMTThread::Terminate

Forced completion of a thread.

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">void&nbsp;&nbsp;</span><span class="f_Functions">CMTThread::Terminate</span><span class="f_CodeExample">()</span></p></td></tr></tbody></table>

Note

It is recommended not to use this method.

For a forced completion of a thread you should better use a special completion flag, which is checked from the [thread operation function](/en/docs/mt5/api/cmtthread/cmtthread_start).
