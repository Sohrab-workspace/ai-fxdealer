...
> Source: https://support.metaquotes.net/en/docs/mt5/api/cmtthread/cmtthread_handle
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Tools](/en/docs/mt5/api/reference_tools)[CMTThread](/en/docs/mt5/api/cmtthread)Handle

# CMTThread::Handle

Get a thread handle (WinAPI-descriptor).

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">HANDLE&nbsp;&nbsp;</span><span class="f_Functions">CMTThread::Handle</span><span class="f_CodeExample">()</span></p></td></tr></tbody></table>
