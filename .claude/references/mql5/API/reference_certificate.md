...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reference_certificate
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Database Interfaces](/en/docs/mt5/api/reference_bases)Certificates

# Certificates

The MetaTrader 5 API allows managing the database of certificates used for extended authentication of [users](/en/docs/mt5/api/reference_user) on servers. The [IMTCertificate](/en/docs/mt5/api/reference_certificate/imtcertificate) interface is provided for working with certificates.
