...
> Source: https://support.metaquotes.net/en/docs/mt5/api/config_network/imtconserverhistory/imtconserverhistory_datafeedstimeout
        ...
        -   [Configuration Interfaces](/en/docs/mt5/api/reference_configurations)
            ...
            -   [Network](/en/docs/mt5/api/config_network)
                ...
                -   [IMTConServerHistory](/en/docs/mt5/api/config_network/imtconserverhistory)
                    -   [Release](/en/docs/mt5/api/config_network/imtconserverhistory/imtconserverhistory_release)
                    -   [Assign](/en/docs/mt5/api/config_network/imtconserverhistory/imtconserverhistory_assign)
                    -   [Clear](/en/docs/mt5/api/config_network/imtconserverhistory/imtconserverhistory_clear)
                    -   [DatafeedsTimeout](/en/docs/mt5/api/config_network/imtconserverhistory/imtconserverhistory_datafeedstimeout)
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Configuration Interfaces](/en/docs/mt5/api/reference_configurations)[Network](/en/docs/mt5/api/config_network)[IMTConServerHistory](/en/docs/mt5/api/config_network/imtconserverhistory)DatafeedsTimeout

# IMTConServerHistory::DatafeedsTimeout

Get a timeout of [data feeds](/en/docs/mt5/api/config_datafeeds) before switching to other feed.

C++

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">UINT&nbsp;&nbsp;</span><span class="f_Functions">IMTConServerHistory::DatafeedsTimeout</span><span class="f_CodeExample">()</span><span class="f_Keywords">&nbsp;&nbsp;const</span></p></td></tr></tbody></table>

.NET (Gateway/Manager API)

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">uint&nbsp;&nbsp;</span><span class="f_Functions">IMTConServerHistory::DatafeedsTimeout</span><span class="f_CodeExample">()</span></p></td></tr></tbody></table>

Python (Manager API)

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Functions">MTConServerHistory.DatafeedsTimeout</span></p></td></tr></tbody></table>
...
Set a timeout of [data feeds](/en/docs/mt5/api/config_datafeeds) before switching to other feed.

C++

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">MTAPIRES&nbsp;&nbsp;</span><span class="f_Functions">IMTConServerHistory::DatafeedsTimeout</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">const&nbsp;UINT</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Param">timeout</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Timeout</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>

.NET (Gateway/Manager API)

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">MTRetCode&nbsp;&nbsp;</span><span class="f_Functions">CIMTConServerHistory.DatafeedsTimeout</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">uint</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Param">timeout</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Timeout</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>
