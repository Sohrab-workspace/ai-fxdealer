...
> Source: https://support.metaquotes.net/en/docs/mt5/api/config_manager/imtconmanagersink/imtconmanagersink_onmanagerdelete
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Configuration Interfaces](/en/docs/mt5/api/reference_configurations)[Managers](/en/docs/mt5/api/config_manager)[IMTConManagerSink](/en/docs/mt5/api/config_manager/imtconmanagersink)OnManagerDelete
