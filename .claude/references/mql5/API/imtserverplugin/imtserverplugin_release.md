# IMTServerPlugin::Release

> Source: https://support.metaquotes.net/en/docs/mt5/api/imtserverplugin/imtserverplugin_release
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Server API](/en/docs/mt5/api/serverapi)[Plugin Interface](/en/docs/mt5/api/imtserverplugin)Release
