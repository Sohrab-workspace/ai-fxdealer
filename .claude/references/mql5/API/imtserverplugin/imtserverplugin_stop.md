...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtserverplugin/imtserverplugin_stop
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Server API](/en/docs/mt5/api/serverapi)[Plugin Interface](/en/docs/mt5/api/imtserverplugin)Stop
...
By the time of call of the IMTServerPlugin::Stop method, the plugin automatically unsubscribes from all of the events to which it subscribed earlier. Thus you will get the [MT\_RET\_ERR\_NOTFOUND](/en/docs/mt5/api/retcodes_common) error if you try to unsubscribe from an event within the implementation of the Stop method.
