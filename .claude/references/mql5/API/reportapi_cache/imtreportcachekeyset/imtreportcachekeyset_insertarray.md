...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reportapi_cache/imtreportcachekeyset/imtreportcachekeyset_insertarray
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Data Cache Interfaces](/en/docs/mt5/api/reportapi_cache)[IMTReportCacheKeySet](/en/docs/mt5/api/reportapi_cache/imtreportcachekeyset)InsertArray

# IMTReportCacheKeySet::InsertArray

Add an array of keys to the current set.

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">MTAPIRES</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Functions">IMTReportCacheKeySet::InsertArray</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">const&nbsp;UINT64*</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Param">keys</span><span class="f_CodeExample">,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Array&nbsp;of&nbsp;keys</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">const&nbsp;UINT</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Param">total</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Number&nbsp;of&nbsp;keys</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>
