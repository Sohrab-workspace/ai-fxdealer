# IMTReportCacheKeySet::Clear

> Source: https://support.metaquotes.net/en/docs/mt5/api/reportapi_cache/imtreportcachekeyset/imtreportcachekeyset_clear
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Data Cache Interfaces](/en/docs/mt5/api/reportapi_cache)[IMTReportCacheKeySet](/en/docs/mt5/api/reportapi_cache/imtreportcachekeyset)Clear
