...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reportapi_cache/imtreportcachekeyset/imtreportcachekeyset_containsset
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Data Cache Interfaces](/en/docs/mt5/api/reportapi_cache)[IMTReportCacheKeySet](/en/docs/mt5/api/reportapi_cache/imtreportcachekeyset)ContainsSet

# IMTReportCacheKeySet::ContainsSet

Check if the key set contains all the keys from the passed set.

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">MTAPIRES</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Functions">IMTReportCacheKeySet::ContainsSet</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">const&nbsp;IMTReportCacheKeySet</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Param">*keyset</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Set&nbsp;of&nbsp;keys</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>

Parameters

keyset

\[in\]  The [IMTReportCacheKeySet](/en/docs/mt5/api/reportapi_cache/imtreportcachekeyset) objects: the presence of its keys will be checked in the current object.

Return Value

[MT\_RET\_OK](/en/docs/mt5/api/retcodes_successful), if the passed set of keys exists in the current object.
