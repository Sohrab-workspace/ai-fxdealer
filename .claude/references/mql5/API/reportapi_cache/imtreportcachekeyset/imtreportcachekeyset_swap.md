...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reportapi_cache/imtreportcachekeyset/imtreportcachekeyset_swap
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Data Cache Interfaces](/en/docs/mt5/api/reportapi_cache)[IMTReportCacheKeySet](/en/docs/mt5/api/reportapi_cache/imtreportcachekeyset)Swap

# IMTReportCacheKeySet::Swap

Exchange key sets with the passed object.

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">MTAPIRES</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Functions">IMTReportCacheKeySet::Swap</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">IMTReportCacheKeySet*</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Param">keyset</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Set&nbsp;of&nbsp;keys</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>

Parameters

keyset

\[in\]  The [IMTReportCacheKeySet](/en/docs/mt5/api/reportapi_cache/imtreportcachekeyset) objects, keys from which will replace keys in the current object. Keys from the current object will replace keys in the passed object.
