...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reportapi_memory_management
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)Memory Management
...
-   In cases where the API itself allocates memory (e.g., the [IMTReportAPI::UserLogins](/en/docs/mt5/api/imtreportapi/imtreportapi_user/imtreportapi_userlogins) function, which returns a dynamic array of clients from the specified group), it is necessary to free the memory using the method [IMTReportAPI::Free](/en/docs/mt5/api/imtreportapi/imtreportapi_common/imtreportapi_free).  
    Pair to the method IMTReportAPI::Free is the method [IMTReportAPI::Allocate](/en/docs/mt5/api/imtreportapi/imtreportapi_common/imtreportapi_allocate), which allows to allocate memory.
