...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtgatewayapi/imtgatewayapi_order_control
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Gateway API](/en/docs/mt5/api/gatewayapi)[Main Interface](/en/docs/mt5/api/imtgatewayapi)Controlling Orders in External System
...
<table class="table" cellspacing="0" cellpadding="5" border="1"><thead><tr class="table"><th class="table" style="width:177px;"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Functions</span></p></th><th class="table"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Purpose</span></p></th></tr></thead><tbody><tr class="table"><td class="table" style="width:177px;"><p class="p_fortable"><span class="f_fortable"><a href="/en/docs/mt5/api/imtgatewayapi/imtgatewayapi_order_control/imtgatewayapi_gatewayorderarraycreate" class="topiclink">GatewayOrderArrayCreate</a></span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Create an object of the array of orders.</span></p></td></tr><tr class="table"><td class="table" style="width:177px;"><p class="p_fortable"><span class="f_fortable"><a href="/en/docs/mt5/api/imtgatewayapi/imtgatewayapi_order_control/imtgatewayapi_gatewayordersanswer" class="topiclink">GatewayOrdersAnswer</a></span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Display the client's current pending orders placed in an external system.</span></p></td></tr></tbody></table>
