...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtgatewayapi/imtgatewayapi_settings/imtgatewayapi_settingsget
        ...
        -   [Gateway API](/en/docs/mt5/api/gatewayapi)
            ...
            -   [Main Interface](/en/docs/mt5/api/imtgatewayapi)
                ...
                -   [User Settings](/en/docs/mt5/api/imtgatewayapi/imtgatewayapi_settings)
                    -   [SettingsAdd](/en/docs/mt5/api/imtgatewayapi/imtgatewayapi_settings/imtgatewayapi_settingsadd)
                    -   [SettingsUpdate](/en/docs/mt5/api/imtgatewayapi/imtgatewayapi_settings/imtgatewayapi_settingsupdate)
                    -   [SettingsDelete](/en/docs/mt5/api/imtgatewayapi/imtgatewayapi_settings/imtgatewayapi_settingsdelete)
                    -   [SettingsClear](/en/docs/mt5/api/imtgatewayapi/imtgatewayapi_settings/imtgatewayapi_settingsclear)
                    -   [SettingsTotal](/en/docs/mt5/api/imtgatewayapi/imtgatewayapi_settings/imtgatewayapi_settingstotal)
                    -   [SettingsNext](/en/docs/mt5/api/imtgatewayapi/imtgatewayapi_settings/imtgatewayapi_settingsnext)
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Gateway API](/en/docs/mt5/api/gatewayapi)[Main Interface](/en/docs/mt5/api/imtgatewayapi)[User Settings](/en/docs/mt5/api/imtgatewayapi/imtgatewayapi_settings)SettingsGet
...
<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">MTAPIRES&nbsp;&nbsp;</span><span class="f_Functions">IMTGatewayAPI::SettingsGet</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">LPCWSTR</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Param">name</span><span class="f_CodeExample">,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Setting&nbsp;name</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">IMTConParam*</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Param">param</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Setting&nbsp;object</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>

.NET

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">MTRetCode&nbsp;&nbsp;</span><span class="f_Functions">CIMTGatewayAPI.SettingsGet</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">string</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Param">name</span><span class="f_CodeExample">,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Setting&nbsp;name</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">CIMTConParam</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Param">param</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Setting&nbsp;object</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>
...
\[out\] [An object of the parameter setting](/en/docs/mt5/api/config_param/imtconparam). The param object must first be created using the method [IMTGatewayAPI::FeederParamCreate](/en/docs/mt5/api/imtgatewayapi/imtgatewayapi_config/imtgatewayapi_config_datafeeds/imtgatewayapi_feederparamcreate) or [IMTGatewayAPI::GatewayParamCreate](/en/docs/mt5/api/imtgatewayapi/imtgatewayapi_config/imtgatewayapi_config_gateway/imtgatewayapi_gatewayparamcreate).
