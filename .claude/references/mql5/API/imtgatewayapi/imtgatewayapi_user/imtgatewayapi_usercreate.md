...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtgatewayapi/imtgatewayapi_user/imtgatewayapi_usercreate
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Gateway API](/en/docs/mt5/api/gatewayapi)[Main Interface](/en/docs/mt5/api/imtgatewayapi)[Users](/en/docs/mt5/api/imtgatewayapi/imtgatewayapi_user)UserCreate
...
<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">IMTUser*&nbsp;&nbsp;</span><span class="f_Functions">IMTGatewayAPI::UserCreate</span><span class="f_CodeExample">()</span></p></td></tr></tbody></table>

.NET

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">CIMTUser&nbsp;&nbsp;</span><span class="f_Functions">CIMTGatewayAPI.UserCreate</span><span class="f_CodeExample">()</span></p></td></tr></tbody></table>

Return Value

It returns a pointer to the created object that implements the [IMTUser](/en/docs/mt5/api/reference_user/imtuser) interface. In case of failure, it returns NULL.

Note

The created object must be deleted by calling the [IMTUser::Release](/en/docs/mt5/api/reference_user/imtuser/imtuser_release) method of this object.
