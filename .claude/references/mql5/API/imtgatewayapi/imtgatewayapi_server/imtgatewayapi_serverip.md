...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtgatewayapi/imtgatewayapi_server/imtgatewayapi_serverip
        ...
        -   [Gateway API](/en/docs/mt5/api/gatewayapi)
            ...
            -   [Main Interface](/en/docs/mt5/api/imtgatewayapi)
                ...
                -   [Server](/en/docs/mt5/api/imtgatewayapi/imtgatewayapi_server)
                    -   [Start](/en/docs/mt5/api/imtgatewayapi/imtgatewayapi_server/imtgatewayapi_start)
                    -   [Stop](/en/docs/mt5/api/imtgatewayapi/imtgatewayapi_server/imtgatewayapi_stop)
                    -   [ServerIP](/en/docs/mt5/api/imtgatewayapi/imtgatewayapi_server/imtgatewayapi_serverip)
                    -   [ServerPort](/en/docs/mt5/api/imtgatewayapi/imtgatewayapi_server/imtgatewayapi_serverport)
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Gateway API](/en/docs/mt5/api/gatewayapi)[Main Interface](/en/docs/mt5/api/imtgatewayapi)[Server](/en/docs/mt5/api/imtgatewayapi/imtgatewayapi_server)ServerIP
...
<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">MTAPIRES&nbsp;&nbsp;</span><span class="f_Functions">IMTGatewayAPI::ServerIP</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">MTAPISTR&amp;</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Param">ip</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;IP&nbsp;address</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>

.NET

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">MTRetCode&nbsp;&nbsp;</span><span class="f_Functions">CIMTGatewayAPI.ServerIP</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">out&nbsp;string</span><span class="f_CodeExample">&nbsp;</span><span class="f_Param">ip</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;IP&nbsp;address</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>

Parameters

ip

\[out\]  IP address on which the server port is running. In case several addresses have been specified via [IMTGatewayAPI::Start](/en/docs/mt5/api/imtgatewayapi/imtgatewayapi_server/imtgatewayapi_start) method, ServerIP method will return them in the same format - separated with a comma. For example, address1:port1,address2:port2.
...
The IP address on which the Gateway API server port is running is determined by the [IMTGatewayAPI::Start](/en/docs/mt5/api/imtgatewayapi/imtgatewayapi_server/imtgatewayapi_start) method.
