...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtgatewayapi/imtgatewayapi_config/imtgatewayapi_config_symbol/imtgatewayapi_symbolunsubscribe
...
This is a pair method to [IMTGatewayAPI::SymbolSubscribe](/en/docs/mt5/api/imtgatewayapi/imtgatewayapi_config/imtgatewayapi_config_symbol/imtgatewayapi_symbolsubscribe). If an attempt is made to unsubscribe from the interface to which it has not subscribed, [MT\_RET\_ERR\_NOTFOUND](/en/docs/mt5/api/retcodes_common) error is returned.
