...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtgatewayapi/imtgatewayapi_config/imtgatewayapi_config_symbol/imtgatewayapi_symboltotal
...
<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">UINT&nbsp;&nbsp;</span><span class="f_Functions">IMTGatewayAPI::SymbolTotal</span><span class="f_CodeExample">()</span></p></td></tr></tbody></table>

.NET

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">uint&nbsp;&nbsp;</span><span class="f_Functions">CIMTGatewayAPI.SymbolTotal</span><span class="f_CodeExample">()</span></p></td></tr></tbody></table>
...
[IMTConGateway::Symbol\*](/en/docs/mt5/api/config_gateway/imtcongateway/imtcongateway_symboladd) and [IMTConFeeder::Symbol\*](/en/docs/mt5/api/config_datafeeds/imtconfeeder/imtconfeeder_symboladd) methods groups are provided for working with available symbols.
