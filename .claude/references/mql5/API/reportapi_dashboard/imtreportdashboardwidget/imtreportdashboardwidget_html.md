...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reportapi_dashboard/imtreportdashboardwidget/imtreportdashboardwidget_html
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Dashboard Interfaces](/en/docs/mt5/api/reportapi_dashboard)[IMTReportDashboardWidget](/en/docs/mt5/api/reportapi_dashboard/imtreportdashboardwidget)Html

# IMTReportDashboardWidget::Html

Get data displayed in the widget as HTML content.

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">IMTReportDashboardHtml*&nbsp;&nbsp;</span><span class="f_Functions">IMTReportDashboardWidget::Html</span><span class="f_CodeExample">()</span><span class="f_Keywords">&nbsp;&nbsp;const</span></p></td></tr></tbody></table>

Return Value

[HTML content object](/en/docs/mt5/api/reportapi_dashboard/imtreportdashboardhtml).

# IMTReportDashboardWidget::Html

Add data to be displayed in the widget as HTML content.

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">MTAPIRES&nbsp;&nbsp;</span><span class="f_Functions">IMTReportDashboardWidget::Html</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">IMTReportDashboardHtml*</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Param">html</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;HTML&nbsp;content&nbsp;object</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>

Parameters

chart

\[in\] [HTML content object](/en/docs/mt5/api/reportapi_dashboard/imtreportdashboardhtml). To create an object, use [IMTReportAPI::DashboardHtmlAppend](/en/docs/mt5/api/imtreportapi/imtreportapi_dashboard/imtreportapi_dashboardhtmlappend)
...
HTML data can be displayed only in the widgets of [IMTReportDashboardWidget::WIDGET\_TYPE\_HTML](/en/docs/mt5/api/reportapi_dashboard/imtreportdashboardwidget/imtreportdashboardwidget_html) type.

The same HTML data can be bound to multiple widgets.

One widget cannot use both [IMTDataset](/en/docs/mt5/api/reportapi_dataset/imtdataset) and [IMTReportDashboardHtml](/en/docs/mt5/api/reportapi_dashboard/imtreportdashboardhtml) data types.
