...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reportapi_dashboard/imtreportdashboardhtml/imtreportdashboardhtml_tplprocess
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Dashboard Interfaces](/en/docs/mt5/api/reportapi_dashboard)[IMTReportDashboardHtml](/en/docs/mt5/api/reportapi_dashboard/imtreportdashboardhtml)TplProcess

# IMTReportAPI::TplProcess

Set the feature of the processing of all tags inside the current macro (predetermined tag).

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">MTAPIRES&nbsp;&nbsp;</span><span class="f_Functions">IMTReportAPI::TplProcess</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">const&nbsp;UINT</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Param">flags</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;processing&nbsp;flag</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>

Parameters

flags

\[in\]  Flag of a macro processing necessity. Transfered using the [IMTReportAPI::EnTplProcessFlags](/en/docs/mt5/api/imtreportapi/imtreportapi_enum#entplprocessflags) enumeration.
...
In fact, this method determines the necessity of processing the macro received by the [IMTReportDashboardHtml::TplNext](/en/docs/mt5/api/reportapi_dashboard/imtreportdashboardhtml/imtreportdashboardhtml_tplnext) method.
