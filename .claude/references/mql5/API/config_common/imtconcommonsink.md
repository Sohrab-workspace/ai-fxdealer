...
> Source: https://support.metaquotes.net/en/docs/mt5/api/config_common/imtconcommonsink
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Configuration Interfaces](/en/docs/mt5/api/reference_configurations)[Common](/en/docs/mt5/api/config_common)IMTConCommonSink

# IMTConCommonSink

The IMTConCommonSink class contains handlers of event of common configuration change:

<table class="table" cellspacing="0" cellpadding="5" border="1"><thead><tr class="table"><th class="table" style="width:126px;"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Method</span></p></th><th class="table"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Purpose</span></p></th></tr></thead><tbody><tr class="table"><td class="table" style="width:126px;"><p class="p_fortable"><span class="f_fortable"><a href="/en/docs/mt5/api/config_common/imtconcommonsink/imtconcommonsink_oncommonupdate" class="topiclink">OnCommonUpdate</a></span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">The handler of the event of common configuration update.</span></p></td></tr><tr class="table"><td class="table" style="width:126px;"><p class="p_fortable"><span class="f_fortable"><a href="/en/docs/mt5/api/config_common/imtconcommonsink/imtconcommonsink_oncommonsync" class="topiclink">OnCommonSync</a></span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">This method is called by the API to notify that a common configuration has been updated.</span></p></td></tr></tbody></table>
