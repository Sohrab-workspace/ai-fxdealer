...
> Source: https://support.metaquotes.net/en/docs/mt5/api/config_plugins/imtconpluginsink/imtconpluginsink_onplugindelete
        ...
        -   [Configuration Interfaces](/en/docs/mt5/api/reference_configurations)
            ...
            -   [Plugins](/en/docs/mt5/api/config_plugins)
                ...
                -   [IMTConPluginSink](/en/docs/mt5/api/config_plugins/imtconpluginsink)
                    -   [OnPluginAdd](/en/docs/mt5/api/config_plugins/imtconpluginsink/imtconpluginsink_onpluginadd)
                    -   [OnPluginUpdate](/en/docs/mt5/api/config_plugins/imtconpluginsink/imtconpluginsink_onpluginupdate)
                    -   [OnPluginDelete](/en/docs/mt5/api/config_plugins/imtconpluginsink/imtconpluginsink_onplugindelete)
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Configuration Interfaces](/en/docs/mt5/api/reference_configurations)[Plugins](/en/docs/mt5/api/config_plugins)[IMTConPluginSink](/en/docs/mt5/api/config_plugins/imtconpluginsink)OnPluginDelete
...
<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">virtual&nbsp;void&nbsp;&nbsp;</span><span class="f_Functions">IMTConPluginSink::OnPluginDelete</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">const&nbsp;IMTConPlugin*</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Param">plugin</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;A&nbsp;pointer&nbsp;to&nbsp;the&nbsp;configuration&nbsp;module</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>

.NET (Gateway/Manager API)

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">virtual&nbsp;void&nbsp;&nbsp;</span><span class="f_Functions">CIMTConPluginSink.OnPluginDelete</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">CIMTConPlugin</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Param">plugin</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Configuration&nbsp;object</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>
