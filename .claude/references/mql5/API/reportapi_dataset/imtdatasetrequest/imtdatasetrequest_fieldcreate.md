...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reportapi_dataset/imtdatasetrequest/imtdatasetrequest_fieldcreate
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Dataset Interfaces](/en/docs/mt5/api/reportapi_dataset)[IMTDatasetRequest](/en/docs/mt5/api/reportapi_dataset/imtdatasetrequest)FieldCreate

# IMTDatasetRequest::FieldCreate

Create a field object.

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">IMTDatasetField*</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Functions">IMTDatasetRequest::FieldCreate</span><span class="f_CodeExample">()</span></p></td></tr></tbody></table>

Return Value

Returns a pointer to the created object which implements the [IMTDatasetField](/en/docs/mt5/api/reportapi_dataset/imtdatasetfield) interface. In case of failure, it returns NULL.

Note

The created object must be destroyed by calling the [IMTDatasetField::Release](/en/docs/mt5/api/reportapi_dataset/imtdatasetfield/imtdatasetfield_release) method of this object.
