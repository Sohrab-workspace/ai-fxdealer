# IMTDatasetColumn::Clear

> Source: https://support.metaquotes.net/en/docs/mt5/api/reportapi_dataset/imtdatasetcolumn/imtdatasetcolumn_clear
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Dataset Interfaces](/en/docs/mt5/api/reportapi_dataset)[IMTDatasetColumn](/en/docs/mt5/api/reportapi_dataset/imtdatasetcolumn)Clear

# IMTDatasetColumn::Clear

Clear an object.

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">MTAPIRES&nbsp;&nbsp;</span><span class="f_Functions">IMTDatasetColumn::Clear</span><span class="f_CodeExample">()</span></p></td></tr></tbody></table>
