...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reference_trading/trading_order/imthistorysink/imthistorysink_onhistorysync
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Database Interfaces](/en/docs/mt5/api/reference_bases)[Trade](/en/docs/mt5/api/reference_trading)[Orders](/en/docs/mt5/api/reference_trading/trading_order)[IMTHistorySink](/en/docs/mt5/api/reference_trading/trading_order/imthistorysink)OnHistorySync
...
<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">virtual&nbsp;void&nbsp;&nbsp;</span><span class="f_Functions">CIMTHistorySink.OnHistorySync</span><span class="f_CodeExample">()</span></p></td></tr></tbody></table>
