...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reference_trading/trading_request
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Database Interfaces](/en/docs/mt5/api/reference_bases)[Trade](/en/docs/mt5/api/reference_trading)Trade Requests

# Trade Requests

Interfaces provide access to managing trade requests received on the server, as well as allow creating requests.

The following interfaces are available for working with trade requests:

-   [IMTRequest](/en/docs/mt5/api/reference_trading/trading_request/imtrequest)  
    An interface that provides access to the parameters of trade requests.
-   [IMTRequestArray](/en/docs/mt5/api/reference_trading/trading_request/imtrequestarray)  
    An interface for working with the arrays of trade requests.
-   [IMTRequestSink](/en/docs/mt5/api/reference_trading/trading_request/imtrequestsink)  
    An interface that contains handlers of events associated with trade requests.
-   [IMTConfirm](/en/docs/mt5/api/reference_trading/trading_request/imtconfirm)  
    An interface for confirming trade requests.
-   [IMTExecution](/en/docs/mt5/api/reference_trading/trading_request/imtexecution)  
    A trade execution interface.

[OnAccountStopOutLeave](/en/docs/mt5/api/reference_trading/user_account/imtaccountsink/imtaccountsink_onaccountstopoutleave)
