...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reference_trading/trading_exposure/imtexposuresink
            ...
            -   [Trade](/en/docs/mt5/api/reference_trading)
                ...
                -   [Assets](/en/docs/mt5/api/reference_trading/trading_exposure)
                    ...
                    -   [IMTExposureSink](/en/docs/mt5/api/reference_trading/trading_exposure/imtexposuresink)
                        -   [OnExposureUpdate](/en/docs/mt5/api/reference_trading/trading_exposure/imtexposuresink/imtexposuresink_onexposureupdate)
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Database Interfaces](/en/docs/mt5/api/reference_bases)[Trade](/en/docs/mt5/api/reference_trading)[Assets](/en/docs/mt5/api/reference_trading/trading_exposure)IMTExposureSink

# IMTExposureSink

The IMTExposureSink class contains the following methods:

<table class="table" cellspacing="0" cellpadding="5" border="1"><thead><tr class="table"><th class="table" style="width:131px;"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Method</span></p></th><th class="table"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Purpose</span></p></th></tr></thead><tbody><tr class="table"><td class="table" style="width:131px;"><p class="p_fortable"><span class="f_fortable"><a href="/en/docs/mt5/api/reference_trading/trading_exposure/imtexposuresink/imtexposuresink_onexposureupdate" class="topiclink">OnExposureUpdate</a></span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">A handler of the exposure modification event.</span></p></td></tr></tbody></table>
