...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reference_trading/trading_request/imtexecution/imtexecution_apidatarawmax
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Database Interfaces](/en/docs/mt5/api/reference_bases)[Trade](/en/docs/mt5/api/reference_trading)[Trade Requests](/en/docs/mt5/api/reference_trading/trading_request)[IMTExecution](/en/docs/mt5/api/reference_trading/trading_request/imtexecution)APIDataRawMax
...
<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">uint&nbsp;&nbsp;</span><span class="f_Functions">CIMTExecution.APIDataRawMax</span><span class="f_CodeExample">()</span></p></td></tr></tbody></table>
...
Use this method when reading and writing custom parameters in a raw form via [IMTExecution::APIDataRawGet](/en/docs/mt5/api/reference_trading/trading_request/imtexecution/imtexecution_apidatarawget) and [IMTExecution::APIDataRawSet](/en/docs/mt5/api/reference_trading/trading_request/imtexecution/imtexecution_apidatarawset).
