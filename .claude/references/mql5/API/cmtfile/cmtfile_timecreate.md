...
> Source: https://support.metaquotes.net/en/docs/mt5/api/cmtfile/cmtfile_timecreate
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Tools](/en/docs/mt5/api/reference_tools)[CMTFile](/en/docs/mt5/api/cmtfile)TimeCreate
