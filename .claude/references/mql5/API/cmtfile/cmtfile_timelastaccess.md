...
> Source: https://support.metaquotes.net/en/docs/mt5/api/cmtfile/cmtfile_timelastaccess
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Tools](/en/docs/mt5/api/reference_tools)[CMTFile](/en/docs/mt5/api/cmtfile)TimeLastAccess

# CMTFile::TimeLastAccess

Get the time of the last access to the currently open file.

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">FILETIME&nbsp;&nbsp;</span><span class="f_Functions">CMTFile::TimeLastAccess</span><span class="f_CodeExample">()</span><span class="f_Keywords">&nbsp;&nbsp;const</span></p></td></tr></tbody></table>
