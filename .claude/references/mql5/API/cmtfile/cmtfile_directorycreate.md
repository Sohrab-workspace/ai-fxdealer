...
> Source: https://support.metaquotes.net/en/docs/mt5/api/cmtfile/cmtfile_directorycreate
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Tools](/en/docs/mt5/api/reference_tools)[CMTFile](/en/docs/mt5/api/cmtfile)DirectoryCreate

# CMTFile::DirectoryCreate

Create a directory.

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">static&nbsp;bool&nbsp;&nbsp;</span><span class="f_Functions">CMTFile::DirectoryCreate</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">const&nbsp;CMTStr&amp;</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Param">path</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Path&nbsp;to&nbsp;the&nbsp;directory</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>
