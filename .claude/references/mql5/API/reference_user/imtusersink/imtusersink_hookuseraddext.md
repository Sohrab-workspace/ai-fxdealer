...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reference_user/imtusersink/imtusersink_hookuseraddext
...
If the event handler returns a code other than [MT\_RET\_OK](/en/docs/mt5/api/retcodes_successful), the account will not be added and the hook will not be passed to other handlers (including hooks in other plugins).
