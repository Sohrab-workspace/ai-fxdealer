...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reportapi_examples/gateways_turnover_report
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Ready-made Examples](/en/docs/mt5/api/reportapi_examples)Gateways Turnover
