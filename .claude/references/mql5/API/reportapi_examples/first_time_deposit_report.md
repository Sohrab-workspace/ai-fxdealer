...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reportapi_examples/first_time_deposit_report
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Ready-made Examples](/en/docs/mt5/api/reportapi_examples)First Time Deposit

# First Time Deposit

The report is available as a set of diagrams presenting information about first-time deposits made by clients.

![The "First Time Deposit" report](/en/docs/mt5/api/img/first_time_deposit.png "The "First Time Deposit" report")
...
![The "First Time Deposit Daily" report](/en/docs/mt5/api/img/first_time_deposit_daily.png "The "First Time Deposit Daily" report")
...
![The "First Time Deposit Amount" report](/en/docs/mt5/api/img/first_time_deposit_amount.png "The "First Time Deposit Amount" report")
