...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reportapi_examples/lifetime_value_report
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Ready-made Examples](/en/docs/mt5/api/reportapi_examples)Lifetime Value
...
![The "Lifetime Value" report](/en/docs/mt5/api/img/life_time_value.png "The "Lifetime Value" report")
...
<table class="attentable" cellspacing="0" cellpadding="8" border="1"><tbody><tr class="attentable"><td class="attentable"><ul><li class="p_tableatten"><span class="f_tableatten">Balance operation values reflected in charts are automatically converted to the same currency in accordance with current quotes. The report currency is configured on the trade server side.</span></li></ul><ul><li class="p_tableatten"><span class="f_tableatten">Lead Campaign and Lead Source data are available in appropriate fields of <a href="/en/docs/mt5/api/reference_user/imtuser/imtuser_leadcampaign" class="topiclink">trading accounts</a>.</span></li></ul></td></tr></tbody></table>
...
![Report "Lifetime Value Detailed by Client"](/en/docs/mt5/api/img/life_time_value_detailed.png "Report "Lifetime Value Detailed by Client"")
