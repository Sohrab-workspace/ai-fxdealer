...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reportapi_examples/daily_positions_report
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Ready-made Examples](/en/docs/mt5/api/reportapi_examples)Daily Positions

# Daily Positions

Daily Positions Report features information about [trading positions](/en/docs/mt5/api/reference_trading/trading_position/imtposition) which remained open at the end of the selected day.
...
<table class="attentable" cellspacing="0" cellpadding="8" border="1"><tbody><tr class="attentable"><td class="attentable"><p class="p_tableatten"><span class="f_tableatten"><a href="/en/docs/mt5/api/config_group/imtcongroup/imtcongroup_enum#enreportsmode" class="topiclink">Daily reports</a> must be enabled on the server for the group containing the necessary accounts, to generate this type of reports.</span></p></td></tr></tbody></table>
...
-   Login — the account of the [number](/en/docs/mt5/api/reference_user/imtuser) on which the position was opened.
...
-   Commission — the amount of position withheld on the position. It is calculated as the sum of commissions on [deals](/en/docs/mt5/api/reference_trading/trading_deal/imtdeal/imtdeal_commission) by which the position was formed.
...
-   Reason — [reason for](/en/docs/mt5/api/reference_trading/trading_position/imtposition/imtposition_reason) opening a position.
