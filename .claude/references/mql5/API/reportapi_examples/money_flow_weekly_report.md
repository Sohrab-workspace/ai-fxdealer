...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reportapi_examples/money_flow_weekly_report
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Ready-made Examples](/en/docs/mt5/api/reportapi_examples)Money Flow Weekly
...
![The "Money Flow Weekly" report](/en/docs/mt5/api/img/money_flow_weekly.png "The "Money Flow Weekly" report")
