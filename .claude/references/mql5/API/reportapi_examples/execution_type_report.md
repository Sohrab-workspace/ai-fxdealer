...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reportapi_examples/execution_type_report
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Ready-made Examples](/en/docs/mt5/api/reportapi_examples)Execution Types
...
![Deals Count Graph](/en/docs/mt5/api/img/execution_report_deal_count.png "Deals Count Graph")
...
![Deals Volume Graph](/en/docs/mt5/api/img/execution_report_deal_volume.png "Deals Volume Graph")
