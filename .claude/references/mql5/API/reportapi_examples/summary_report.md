...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reportapi_examples/summary_report
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Ready-made Examples](/en/docs/mt5/api/reportapi_examples)Summary
...
-   Fee — amount of [fees](/en/docs/mt5/api/config_group/imtconcommission/imtconcommission_enum#encommmode) debited from the account for the specified period.
