...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reportapi_examples/daily_orders_report
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Ready-made Examples](/en/docs/mt5/api/reportapi_examples)Daily Orders

# Daily Orders Report

Daily Orders Report features information about [market and pending orders](/en/docs/mt5/api/reference_trading/trading_order/imtorder) which remained open (active) at the end of the selected day.
...
-   Reason — [reason](/en/docs/mt5/api/reference_trading/trading_order/imtorder/imtorder_reason) for placing the order.
-   State — [order state](/en/docs/mt5/api/reference_trading/trading_order/imtorder/imtorder_state) at the end of the day for which the report is generated.
