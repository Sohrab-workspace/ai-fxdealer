...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reportapi_examples/retention_of_clients_report
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Ready-made Examples](/en/docs/mt5/api/reportapi_examples)Retention of Clients
...
![The "Retention of Clients" report](/en/docs/mt5/api/img/retention_of_clients.png "The "Retention of Clients" report")
...
The report is generated based on [clients](/en/docs/mt5/api/reference_client/imtclient). A client can have multiple trading accounts, and thus only one (the first) connection from any of the accounts will be reflected in the report.

<table class="attentable" cellspacing="0" cellpadding="8" border="1"><tbody><tr class="attentable"><td class="attentable"><p class="p_tableatten"><span class="f_tableatten">Lead Campaign and Lead Source data are available in appropriate fields of <a href="/en/docs/mt5/api/reference_user/imtuser/imtuser_leadcampaign" class="topiclink">trading accounts</a>.</span></p></td></tr></tbody></table>
