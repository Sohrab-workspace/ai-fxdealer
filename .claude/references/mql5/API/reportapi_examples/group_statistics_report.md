...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reportapi_examples/group_statistics_report
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Ready-made Examples](/en/docs/mt5/api/reportapi_examples)Trade Group Statistics
...
-   Trade: Other — the share of trades executed by [other methods](/en/docs/mt5/api/reference_trading/trading_deal/imtdeal/imtdeal_reason).
