...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reportapi_examples/positions_history_report
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Ready-made Examples](/en/docs/mt5/api/reportapi_examples)Positions History
...
-   Reason — [reason for](/en/docs/mt5/api/reference_trading/trading_position/imtposition/imtposition_enum#enpositionreason) opening a position.
-   Commission — total commission for all deals related to the position.
-   Fee — total [fee](/en/docs/mt5/api/config_group/imtconcommission/imtconcommission_enum#encommmode) for all deals related to the position.
