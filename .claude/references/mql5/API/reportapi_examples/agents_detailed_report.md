...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reportapi_examples/agents_detailed_report
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Ready-made Examples](/en/docs/mt5/api/reportapi_examples)Agents Detailed

# Agents Detailed Report

Agents Detailed Report is a detailed report on agent commissions. The report reflects deals related to paying commissions [accumulated during a trading day/month](/en/docs/mt5/api/config_group/imtconcommission/imtconcommission_chargemode), as well as client deals, for which the agent received immediate commissions.
...
-   Commission — [standard commission](/en/docs/mt5/api/config_group/imtconcommission/imtconcommission_enum#encommmode) for the deal.
