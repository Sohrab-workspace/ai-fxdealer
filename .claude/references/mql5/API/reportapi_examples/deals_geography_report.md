...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reportapi_examples/deals_geography_report
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Ready-made Examples](/en/docs/mt5/api/reportapi_examples)Deals Geography
...
![The "Deals Geography" report](/en/docs/mt5/api/img/deals_geography.png "The "Deals Geography" report")
