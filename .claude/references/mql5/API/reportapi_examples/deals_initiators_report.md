...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reportapi_examples/deals_initiators_report
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Ready-made Examples](/en/docs/mt5/api/reportapi_examples)Deals Initiators

# Deals Initiators

Deal Initiators ([reasons](/en/docs/mt5/api/reference_trading/trading_deal/imtdeal/imtdeal_enum#endealreason)) report. The report demonstrates how traders prefer to perform operations: manually from the desktop or mobile terminal, using trading robots or copying signals. In addition, it shows which methods generate the greatest profit and loss.

![The "Deals Initiators" report](/en/docs/mt5/api/img/deals_initiators.png "The "Deals Initiators" report")
...
-   Volume — distribution of the total volume of deals execution [reasons](/en/docs/mt5/api/reference_trading/trading_deal/imtdeal/imtdeal_enum#endealreason) and by time.
