...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reportapi_examples/deals_history_report
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Ready-made Examples](/en/docs/mt5/api/reportapi_examples)Deals History
...
-   Reason — [the reason](/en/docs/mt5/api/reference_trading/trading_deal/imtdeal/imtdeal_enum#endealreason) for executing the deal.
-   Commission — commission charged for the deal execution.
-   Fee — [fee](/en/docs/mt5/api/config_group/imtconcommission/imtconcommission_enum#encommmode) charged for the deal execution.
-   Swap — swap size.
