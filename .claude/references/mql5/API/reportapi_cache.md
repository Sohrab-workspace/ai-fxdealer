# Data Cache Interfaces

> Source: https://support.metaquotes.net/en/docs/mt5/api/reportapi_cache
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)Data Cache Interfaces

# Data Cache Interfaces

The interfaces described in this section are used for working with the [data cache](/en/docs/mt5/api/imtreportapi/imtreportapi_cache):

-   [IMTReportCache](/en/docs/mt5/api/reportapi_cache/imtreportcache) contains methods for working with the cache, i.e. for data reading and writing.
-   [IMTReportCacheValue](/en/docs/mt5/api/reportapi_cache/imtreportcachevalue) creates methods for working with the cache value and iterating between values.
-   [IMTReportCacheKeySet](/en/docs/mt5/api/reportapi_cache/imtreportcachekeyset) creates methods for working with the sets of data cache keys.
