...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imttradesink/imttradesink_ontraderequestprocesscloseby
...
\[in\]  A pointer to the object of the [deal](/en/docs/mt5/api/reference_trading/trading_deal/imtdeal) of ENTRY\_OUT\_BY type, which was executed in order to close the source position.

deal\_by

\[in\]  A pointer to the object of the [deal](/en/docs/mt5/api/reference_trading/trading_deal/imtdeal) of ENTRY\_OUT\_BY type, which was executed in order to close the opposite position.
