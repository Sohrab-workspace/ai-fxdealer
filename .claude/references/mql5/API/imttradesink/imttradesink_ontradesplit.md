...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imttradesink/imttradesink_ontradesplit
...
\[in\]  A pointer to the object describing the [trading position](/en/docs/mt5/api/reference_trading/trading_position/imtposition) state before the split.

position\_new

\[in\]  A pointer to the object describing the [trading position](/en/docs/mt5/api/reference_trading/trading_position/imtposition) state after the split. New prices and new volumes are set for this position in accordance with the split parameters.
