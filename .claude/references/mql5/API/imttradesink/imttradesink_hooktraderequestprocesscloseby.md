...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imttradesink/imttradesink_hooktraderequestprocesscloseby
...
\[in\]\[out\]  A pointer to the object of a [trade position](/en/docs/mt5/api/reference_trading/trading_position/imtposition), which corresponds to the client and symbol, for which a request is being processed.
