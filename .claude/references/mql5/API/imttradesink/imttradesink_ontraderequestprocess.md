...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imttradesink/imttradesink_ontraderequestprocess
...
\[in\]\[  A pointer to the object of a [trade deal](/en/docs/mt5/api/reference_trading/trading_deal/imtdeal) created as a result of the execution of a trade request.
