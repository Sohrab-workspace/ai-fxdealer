...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtserverapi/serverapi_ticks/imtserverapi_tickstat
...
\[out\]  A pointer to the structure that describes statistical price information ([MTTickStat](/en/docs/mt5/api/mttickstat)).
