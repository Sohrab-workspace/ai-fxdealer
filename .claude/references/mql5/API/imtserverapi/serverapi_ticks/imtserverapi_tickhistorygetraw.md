...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtserverapi/serverapi_ticks/imtserverapi_tickhistorygetraw
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Server API](/en/docs/mt5/api/serverapi)[Main API Interface](/en/docs/mt5/api/imtserverapi)[Tick Data](/en/docs/mt5/api/imtserverapi/serverapi_ticks)TickHistoryGetRaw
