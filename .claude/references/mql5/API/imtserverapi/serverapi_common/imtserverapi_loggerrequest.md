...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtserverapi/serverapi_common/imtserverapi_loggerrequest
...
\[out\]  A pointer to the array of structures that describe logs ([MTLogRecord](/en/docs/mt5/api/mtlogrecord)).
...
After using, the records array must be released using the [Free](/en/docs/mt5/api/imtserverapi/serverapi_common/imtserverapi_free) method.
