# IMTServerAPI::LoggerFlush

> Source: https://support.metaquotes.net/en/docs/mt5/api/imtserverapi/serverapi_common/imtserverapi_loggerflush
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Server API](/en/docs/mt5/api/serverapi)[Main API Interface](/en/docs/mt5/api/imtserverapi)[Common Functions](/en/docs/mt5/api/imtserverapi/serverapi_common)LoggerFlush

# IMTServerAPI::LoggerFlush

Flush the file buffer of the server journal to a disk.

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">void&nbsp;&nbsp;</span><span class="f_Functions">IMTServerAPI::LoggerFlush</span><span class="f_CodeExample">()</span></p></td></tr></tbody></table>
