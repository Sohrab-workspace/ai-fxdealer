...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtserverapi/serverapi_configuration/serverapi_config_plugins/imtserverapi_plugincreate
...
<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">IMTConPlugin*&nbsp;&nbsp;</span><span class="f_Functions">IMTServerAPI::PluginCreate</span><span class="f_CodeExample">()</span></p></td></tr></tbody></table>

Return Value

It returns a pointer to the created object that implements the [IMTConPlugin](/en/docs/mt5/api/config_plugins/imtconplugin) interface. In case of failure, it returns NULL.

Note

The created object must be deleted by calling the [IMTConPlugin::Release](/en/docs/mt5/api/config_plugins/imtconplugin/imtconplugin_release) method of this object.
