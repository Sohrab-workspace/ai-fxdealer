...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtserverapi/serverapi_book/imtserverapi_bookget
        ...
        -   [Server API](/en/docs/mt5/api/serverapi)
            ...
            -   [Main API Interface](/en/docs/mt5/api/imtserverapi)
                ...
                -   [Depth of Market](/en/docs/mt5/api/imtserverapi/serverapi_book)
                    -   [BookSubscribe](/en/docs/mt5/api/imtserverapi/serverapi_book/imtserverapi_booksubscribe)
                    -   [BookUnsubscribe](/en/docs/mt5/api/imtserverapi/serverapi_book/imtserverapi_bookunsubscribe)
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Server API](/en/docs/mt5/api/serverapi)[Main API Interface](/en/docs/mt5/api/imtserverapi)[Depth of Market](/en/docs/mt5/api/imtserverapi/serverapi_book)BookGet

# IMTServerAPI::BookGet

Get a symbol's Depth of Market.

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">MTAPIRES&nbsp;&nbsp;</span><span class="f_Functions">IMTServerAPI::BookGet</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">LPCWSTR</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Param">symbol</span><span class="f_CodeExample">,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Symbol</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">MTBook&amp;</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Param">book</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;An&nbsp;array&nbsp;of&nbsp;DOM&nbsp;records</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>
...
\[out\]  An array of DOM records of type [MTBook](/en/docs/mt5/api/mtbook).
...
To get information about a symbol's DOM using the IMTServerAPI::BookGet method, it is necessary to subscribe to events of changes in the DOM of this symbol using the [IMTServerAPI::BookSubscribe](/en/docs/mt5/api/imtserverapi/serverapi_book/imtserverapi_booksubscribe) method.
