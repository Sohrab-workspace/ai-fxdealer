...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtserverapi/serverapi_news
        ...
        -   [Server API](/en/docs/mt5/api/serverapi)
            ...
            -   [Main API Interface](/en/docs/mt5/api/imtserverapi)
                ...
                -   [News Database](/en/docs/mt5/api/imtserverapi/serverapi_news)
                    -   [NewsCreate](/en/docs/mt5/api/imtserverapi/serverapi_news/imtserverapi_newscreate)
                    -   [NewsSubscribe](/en/docs/mt5/api/imtserverapi/serverapi_news/imtserverapi_newssubscribe)
                    -   [NewsUnsubscribe](/en/docs/mt5/api/imtserverapi/serverapi_news/imtserverapi_newsunsubscribe)
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Server API](/en/docs/mt5/api/serverapi)[Main API Interface](/en/docs/mt5/api/imtserverapi)News Database
...
<table class="attentable" cellspacing="0" cellpadding="8" border="1"><tbody><tr class="attentable"><td class="attentable"><p class="p_tableatten"><span class="f_tableatten">News functions and interfaces work only on history servers.</span></p></td></tr></tbody></table>

The following functions are available for working with news:

<table class="table" cellspacing="0" cellpadding="5" border="1"><thead><tr class="table"><th class="table" style="width:120px;"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Function</span></p></th><th class="table"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Purpose</span></p></th></tr></thead><tbody><tr class="table"><td class="table" style="width:120px;"><p class="p_fortable"><span class="f_fortable"><a href="/en/docs/mt5/api/imtserverapi/serverapi_news/imtserverapi_newscreate" class="topiclink">NewsCreate</a></span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Create an object of a news item.</span></p></td></tr><tr class="table"><td class="table" style="width:120px;"><p class="p_fortable"><span class="f_fortable"><a href="/en/docs/mt5/api/imtserverapi/serverapi_news/imtserverapi_newssubscribe" class="topiclink">NewsSubscribe</a></span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Subscribe to events and hooks associated with changes in the news database.</span></p></td></tr><tr class="table"><td class="table" style="width:120px;"><p class="p_fortable"><span class="f_fortable"><a href="/en/docs/mt5/api/imtserverapi/serverapi_news/imtserverapi_newsunsubscribe" class="topiclink">NewsUnsubscribe</a></span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Undubscribe from events and hooks associated with changes in the news database.</span></p></td></tr><tr class="table"><td class="table" style="width:120px;"><p class="p_fortable"><span class="f_fortable"><a href="/en/docs/mt5/api/imtserverapi/serverapi_news/imtserverapi_newssend" class="topiclink">NewsSend</a></span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Send news.</span></p></td></tr></tbody></table>
