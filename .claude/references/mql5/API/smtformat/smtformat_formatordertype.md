...
> Source: https://support.metaquotes.net/en/docs/mt5/api/smtformat/smtformat_formatordertype
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Tools](/en/docs/mt5/api/reference_tools)[SMTFormat](/en/docs/mt5/api/smtformat)FormatOrderType

# SMTFormat::FormatOrderType

Format the type of an order in a string with a text description.

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">static&nbsp;LPCWSTR&nbsp;&nbsp;</span><span class="f_Functions">SMTFormat::FormatOrderType</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">CMTStr</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Param">&amp;str</span><span class="f_CodeExample">,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Reference&nbsp;to&nbsp;a&nbsp;string&nbsp;object</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">const&nbsp;UINT</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Param">type</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Order&nbsp;type</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>
...
\[in\]  Order type. Specified by a value of the [IMTOrder::EnOrderType](/en/docs/mt5/api/reference_trading/trading_order/imtorder/imtorder_enum#enordertype) enumeration:

-   IMTOrder::OP\_BUY -"buy";
-   IMTOrder::OP\_SELL - "sell";
-   IMTOrder::OP\_BUY\_LIMIT - "buy limit";
-   IMTOrder::OP\_SELL\_LIMIT - "sell limit";
-   IMTOrder::OP\_BUY\_STOP - "buy stop";
-   IMTOrder::OP\_SELL\_STOP - "sell stop";
-   IMTOrder::OP\_BUY\_STOP\_LIMIT - "buy stop limit";
-   IMTOrder::OP\_SELL\_STOP\_LIMIT - "sell stop limit".
