...
> Source: https://support.metaquotes.net/en/docs/mt5/api/smtformat/smtformat_formatmoney
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Tools](/en/docs/mt5/api/reference_tools)[SMTFormat](/en/docs/mt5/api/smtformat)FormatMoney
...
The method works in the same as [SMTFormat::FormatDouble](/en/docs/mt5/api/smtformat/smtformat_formatdouble), but additionally spaces separating thousands are inserted into the final string.
