...
> Source: https://support.metaquotes.net/en/docs/mt5/api/smtformat/smtformat_formatordertypetime
...
\[in\]  Order expiration type. Specified by a value of the [IMTOrder::EnOrderTime](/en/docs/mt5/api/reference_trading/trading_order/imtorder/imtorder_enum#enordertime) enumeration:

-   IMTOrder::ORDER\_TIME\_GTC - "gtc";
-   IMTOrder::ORDER\_TIME\_DAY - "day";
-   IMTOrder::ORDER\_TIME\_SPECIFIED - "specified".
