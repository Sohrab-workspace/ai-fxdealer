...
> Source: https://support.metaquotes.net/en/docs/mt5/api/smtformat/smtformat_formatpositiontype
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Tools](/en/docs/mt5/api/reference_tools)[SMTFormat](/en/docs/mt5/api/smtformat)FormatPositionType
...
\[in\]  Position type. Specified by a value of the [IMTPosition::EnPositionAction](/en/docs/mt5/api/reference_trading/trading_position/imtposition/imtposition_enum#enpositionaction) enumeration:

-   IMTPosition::POSITION\_BUY - "buy";
-   IMTPosition::POSITION\_SELL - "sell".
