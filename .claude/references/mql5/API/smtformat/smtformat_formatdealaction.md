...
> Source: https://support.metaquotes.net/en/docs/mt5/api/smtformat/smtformat_formatdealaction
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Tools](/en/docs/mt5/api/reference_tools)[SMTFormat](/en/docs/mt5/api/smtformat)FormatDealAction

# SMTFormat::FormatDealAction

Format the type of action performed by a deal to a string with a text description.

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">static&nbsp;LPCWSTR&nbsp;&nbsp;</span><span class="f_Functions">SMTFormat::FormatDealAction</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">CMTStr</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Param">&amp;str</span><span class="f_CodeExample">,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Reference&nbsp;to&nbsp;a&nbsp;string&nbsp;object</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">const&nbsp;UINT</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Param">action</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Type&nbsp;of&nbsp;action</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>
...
\[in\]  Type of action performed by a deal. Specified by a value of the [IMTDeal::EnDealAction](/en/docs/mt5/api/reference_trading/trading_deal/imtdeal/imtdeal_enum#endealaction) enumeration:

-   IMTDeal::DEAL\_BUY - "buy";
-   IMTDeal::DEAL\_SELL - "sell";
-   IMTDeal::DEAL\_BALANCE - "balance";
-   IMTDeal::DEAL\_CREDIT - "credit";
-   IMTDeal::DEAL\_CHARGE\- "charge";
-   IMTDeal::DEAL\_CORRECTION - "correction";
-   IMTDeal::DEAL\_BONUS - "bonus";
-   IMTDeal::DEAL\_COMMISSION - "commission";
-   IMTDeal::DEAL\_COMMISSION\_DAILY - "daily commission";
-   IMTDeal::DEAL\_COMMISSION\_MONTHLY - "monthly commission";
-   IMTDeal::DEAL\_AGENT\_DAILY - "daily agent commission";
-   IMTDeal::DEAL\_AGENT\_MONTHLY - "monthly agent commission";
-   IMTDeal::DEAL\_INTERESTRATE - "interest rate".
