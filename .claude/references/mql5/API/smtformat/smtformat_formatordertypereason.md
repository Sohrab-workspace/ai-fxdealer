...
> Source: https://support.metaquotes.net/en/docs/mt5/api/smtformat/smtformat_formatordertypereason
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Tools](/en/docs/mt5/api/reference_tools)[SMTFormat](/en/docs/mt5/api/smtformat)FormatOrderTypeReason

# SMTFormat::FormatOrderTypeReason

Format the order placing reason in a string with a text description.

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">static&nbsp;LPCWSTR&nbsp;&nbsp;</span><span class="f_Functions">SMTFormat::FormatOrderTypeReason</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">CMTStr</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Param">&amp;str</span><span class="f_CodeExample">,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Reference&nbsp;to&nbsp;a&nbsp;string&nbsp;object</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">UINT</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Param">reason</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Reason&nbsp;for&nbsp;placing&nbsp;the&nbsp;order</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>
...
\[in\]  Reason for placing the order. Specified by a value of the [IMTOrder::EnOrderReason](/en/docs/mt5/api/reference_trading/trading_order/imtorder/imtorder_enum#enorderreason) enumeration:

-   IMTOrder::ORDER\_REASON\_CLIENT - "Client";
-   IMTOrder::ORDER\_REASON\_EXPERT - "Expert";
-   IMTOrder::ORDER\_REASON\_DEALER - "Dealer";
-   IMTOrder::ORDER\_REASON\_SL - "Stop loss";
-   IMTOrder::ORDER\_REASON\_TP -"Take profit";
-   IMTOrder::ORDER\_REASON\_SO - "Stop out";
-   IMTOrder::ORDER\_REASON\_ROLLOVER - "Rollover";
