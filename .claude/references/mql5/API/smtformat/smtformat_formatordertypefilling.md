...
> Source: https://support.metaquotes.net/en/docs/mt5/api/smtformat/smtformat_formatordertypefilling
...
\[in\]  Order filling type. Specified by a value of the [IMTOrder::EnOrderFilling](/en/docs/mt5/api/reference_trading/trading_order/imtorder/imtorder_enum#enorderfilling) enumeration:

-   IMTOrder::ORDER\_FILL\_FOK - "fill or kill";
-   IMTOrder::ORDER\_FILL\_IOC - "immediate or cancel";
-   IMTOrder::ORDER\_FILL\_RETURN - "return".
