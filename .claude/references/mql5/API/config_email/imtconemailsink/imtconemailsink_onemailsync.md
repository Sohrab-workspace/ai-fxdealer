...
> Source: https://support.metaquotes.net/en/docs/mt5/api/config_email/imtconemailsink/imtconemailsink_onemailsync
        ...
        -   [Configuration Interfaces](/en/docs/mt5/api/reference_configurations)
            ...
            -   [Mail Servers](/en/docs/mt5/api/config_email)
                ...
                -   [IMTConEmailSink](/en/docs/mt5/api/config_email/imtconemailsink)
                    -   [OnEmailAdd](/en/docs/mt5/api/config_email/imtconemailsink/imtconemailsink_onemailadd)
                    -   [OnEmailUpdate](/en/docs/mt5/api/config_email/imtconemailsink/imtconemailsink_onemailupdate)
                    -   [OnEmailDelete](/en/docs/mt5/api/config_email/imtconemailsink/imtconemailsink_onemaildelete)
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Configuration Interfaces](/en/docs/mt5/api/reference_configurations)[Mail Servers](/en/docs/mt5/api/config_email)[IMTConEmailSink](/en/docs/mt5/api/config_email/imtconemailsink)OnEmailSync
...
<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">virtual&nbsp;void&nbsp;&nbsp;</span><span class="f_Functions">CIMTConEmailSink.OnEmailSync</span><span class="f_CodeExample">()</span></p></td></tr></tbody></table>
