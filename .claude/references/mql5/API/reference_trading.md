...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reference_trading
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Database Interfaces](/en/docs/mt5/api/reference_bases)Trade

# Trade

Functions and interfaces described in this section allow working with the trading functionality of the MetaTrader 5 platform. Description consists of the following topics:
