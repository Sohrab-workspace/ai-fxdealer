...
> Source: https://support.metaquotes.net/en/docs/mt5/api/cmtstr/cmtstr_str
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Tools](/en/docs/mt5/api/reference_tools)[CMTStr](/en/docs/mt5/api/cmtstr)Str

# CMTStr::Str

Get a constant pointer to a string.

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">cosnt&nbsp;wchar_t*&nbsp;&nbsp;</span><span class="f_Functions">CMTStr::Str</span><span class="f_CodeExample">()</span><span class="f_Keywords">&nbsp;&nbsp;const</span></p></td></tr></tbody></table>
