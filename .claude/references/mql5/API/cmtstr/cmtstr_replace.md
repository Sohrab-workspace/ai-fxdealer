...
> Source: https://support.metaquotes.net/en/docs/mt5/api/cmtstr/cmtstr_replace
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Tools](/en/docs/mt5/api/reference_tools)[CMTStr](/en/docs/mt5/api/cmtstr)Replace

# CMTStr::Replace

Replace the specified substring in the string object with another substring.

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">void&nbsp;&nbsp;</span><span class="f_Functions">CMTStr::Replace</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">wchar_t</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Param">*findstr</span><span class="f_CodeExample">,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Substring&nbsp;to&nbsp;replace</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">wchar_t</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Param">*repstr</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;New&nbsp;substring</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>

Parameters

\*findstr

\[in\]  The substring to to replace.

\*repstr

\[in\]  The substring that will replace the found substring.
