...
> Source: https://support.metaquotes.net/en/docs/mt5/api/cmtstr/cmtstr_refresh
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Tools](/en/docs/mt5/api/reference_tools)[CMTStr](/en/docs/mt5/api/cmtstr)Refresh

# CMTStr::Refresh

Update a cached string size after modification.

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">void&nbsp;&nbsp;</span><span class="f_Functions">CMTStr::Refresh</span><span class="f_CodeExample">()</span></p></td></tr></tbody></table>

Note

This method should be applied if the string was modified outside the methods of the [CMTStr](/en/docs/mt5/api/cmtstr) class (by the pointer).
