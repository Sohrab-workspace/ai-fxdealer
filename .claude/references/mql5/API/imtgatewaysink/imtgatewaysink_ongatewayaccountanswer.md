...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtgatewaysink/imtgatewaysink_ongatewayaccountanswer
...
\[in\] [An object of the array of](/en/docs/mt5/api/reference_trading/trading_order/imtorderarray) client orders.

\*positions

\[in\] [An object of the array of](/en/docs/mt5/api/reference_trading/trading_position/imtpositionarray) client positions.
