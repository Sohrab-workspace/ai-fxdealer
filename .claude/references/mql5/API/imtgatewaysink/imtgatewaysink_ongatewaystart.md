...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtgatewaysink/imtgatewaysink_ongatewaystart
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Gateway API](/en/docs/mt5/api/gatewayapi)[Event Interface](/en/docs/mt5/api/imtgatewaysink)OnGatewayStart

# IMTGatewaySink::OnGatewayStart

A handler of the following event: Gateway API is [synchronized](/en/docs/mt5/api/gatewayapi_interaction) with the platform and is ready for work.

C++

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">virtual&nbsp;void&nbsp;&nbsp;</span><span class="f_Functions">IMTGatewaySink::OnGatewayStart</span><span class="f_CodeExample">()</span></p></td></tr></tbody></table>

.NET

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">virtual&nbsp;void&nbsp;&nbsp;</span><span class="f_Functions">CIMTGatewaySink.OnGatewayStart</span><span class="f_CodeExample">()</span></p></td></tr></tbody></table>

Note

Gateway API business logic elements methods (adding of [symbols](/en/docs/mt5/api/imtgatewayapi/imtgatewayapi_config/imtgatewayapi_config_symbol), connection as a [dealer](/en/docs/mt5/api/imtgatewayapi/imtgatewayapi_dealing), etc.).

This notification ensures that the data is synchronized only with the main and history servers. If additional trade servers are used in the platform, the gateway should start interacting with them only after the appropriate [IMTGatewaySink::OnServerSynchornized](/en/docs/mt5/api/imtgatewaysink/imtgatewaysink_onserversynchronized) notifications are received.
