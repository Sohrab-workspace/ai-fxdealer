...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtgatewaysink/imtgatewaysink_hookserverconnect
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Gateway API](/en/docs/mt5/api/gatewayapi)[Event Interface](/en/docs/mt5/api/imtgatewaysink)HookServerConnect
...
\[in\]  Type of the platform component that is trying to connect. [IMTGatewayAPI::CONNECT\_TYPE\_TRADE](/en/docs/mt5/api/imtgatewayapi/imtgatewayapi_enum#enconnecttype) (trading server) and [IMTGatewayAPI::CONNECT\_TYPE\_HISTORY](/en/docs/mt5/api/imtgatewayapi/imtgatewayapi_enum#enconnecttype) (history server) values are used for passing the type.
