...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reportapi_auxiliary
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)Diagram Interfaces

# Diagram interfaces

This section describes auxiliary interfaces used for building report charts.

-   [IMTReportSeries](/en/docs/mt5/api/reportapi_auxiliary/imtreportseries) — additional interface for working with data series for creating charts.
-   [IMTReportChart](/en/docs/mt5/api/reportapi_auxiliary/imtreportchart) — additional interface for working with charts.
