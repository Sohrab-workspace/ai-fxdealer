...
> Source: https://support.metaquotes.net/en/docs/mt5/api/config_spread/imtconspreadsink/imtconspreadsink_onspreaddelete
        ...
        -   [Configuration Interfaces](/en/docs/mt5/api/reference_configurations)
            ...
            -   [Spreads](/en/docs/mt5/api/config_spread)
                ...
                -   [IMTConSpreadSink](/en/docs/mt5/api/config_spread/imtconspreadsink)
                    -   [OnSpreadAdd](/en/docs/mt5/api/config_spread/imtconspreadsink/imtconspreadsink_onspreadadd)
                    -   [OnSpreadUpdate](/en/docs/mt5/api/config_spread/imtconspreadsink/imtconspreadsink_onspreadupdate)
                    -   [OnSpreadDelete](/en/docs/mt5/api/config_spread/imtconspreadsink/imtconspreadsink_onspreaddelete)
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Configuration Interfaces](/en/docs/mt5/api/reference_configurations)[Spreads](/en/docs/mt5/api/config_spread)[IMTConSpreadSink](/en/docs/mt5/api/config_spread/imtconspreadsink)OnSpreadDelete
...
<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">virtual&nbsp;void&nbsp;&nbsp;</span><span class="f_Functions">IMTConSpreadSink::OnSpreadDelete</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">const&nbsp;IMTConSymbol*</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Param">config</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Pointer&nbsp;to&nbsp;the&nbsp;spread&nbsp;object</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>

.NET (Gateway/Manager API)

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">virtual&nbsp;void&nbsp;&nbsp;</span><span class="f_Functions">CIMTConSpreadSink.OnSpreadDelete</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">CIMTConSymbol&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Param">config</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Spread&nbsp;object</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>
