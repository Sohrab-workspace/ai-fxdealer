...
> Source: https://support.metaquotes.net/en/docs/mt5/api/config_spread/imtconspreadsink/imtconspreadsink_onspreadsync
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Configuration Interfaces](/en/docs/mt5/api/reference_configurations)[Spreads](/en/docs/mt5/api/config_spread)[IMTConSpreadSink](/en/docs/mt5/api/config_spread/imtconspreadsink)OnSpreadSync
...
<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">virtual&nbsp;void&nbsp;&nbsp;</span><span class="f_Functions">CIMTConSpreadSink.OnSpreadSync</span><span class="f_CodeExample">()</span></p></td></tr></tbody></table>
