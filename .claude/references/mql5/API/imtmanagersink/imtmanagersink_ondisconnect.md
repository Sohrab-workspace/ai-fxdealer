...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtmanagersink/imtmanagersink_ondisconnect
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Manager API](/en/docs/mt5/api/managerapi)[Interface of Manager API Events](/en/docs/mt5/api/imtmanagersink)OnDisconnect
...
<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">virtual&nbsp;void&nbsp;&nbsp;</span><span class="f_Functions">CIMTManagerSink.OnDisconnect</span><span class="f_CodeExample">()</span></p></td></tr></tbody></table>
