...
> Source: https://support.metaquotes.net/en/docs/mt5/api/cmtarraybase/cmtarraybase_clear
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Tools](/en/docs/mt5/api/reference_tools)[CMTArrayBase](/en/docs/mt5/api/cmtarraybase)Clear

# CMTArrayBase::Clear

Clear an array.

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">void&nbsp;&nbsp;</span><span class="f_Functions">CMTArrayBase::Clear</span><span class="f_CodeExample">()</span></p></td></tr></tbody></table>

Note

This method removes all elements of the array.
