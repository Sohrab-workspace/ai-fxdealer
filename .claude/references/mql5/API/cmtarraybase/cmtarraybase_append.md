...
> Source: https://support.metaquotes.net/en/docs/mt5/api/cmtarraybase/cmtarraybase_append
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Tools](/en/docs/mt5/api/reference_tools)[CMTArrayBase](/en/docs/mt5/api/cmtarraybase)Append

# CMTArrayBase::Append

Add an empty element to an array.

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">void*&nbsp;&nbsp;</span><span class="f_Functions">CMTArrayBase::Append</span><span class="f_CodeExample">()</span></p></td></tr></tbody></table>
...
After executing this method, the size of the current array object ([CMTArrayBase::Total](/en/docs/mt5/api/cmtarraybase/cmtarraybase_total)) is increased by 1 element. The value of newly added element will be undefined.
