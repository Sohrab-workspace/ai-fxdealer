...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reportapi_multithreading
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)Multithreading
...
-   Calling Report API methods (IMTReportAPI interface methods, e.g., [IMTReportAPI::Chart\*](/en/docs/mt5/api/imtreportapi/imtreportapi_html/imtreportapi_chart_management), [IMTReport::HTML\*](/en/docs/mt5/api/imtreportapi/imtreportapi_html/imtreportapi_html_management) etc.) are not thread safe. When accessing the same object from two threads, the programmer must ensure synchronization of access.
-   Calling the common interface methods (e.g., configuration bases interface: [IMTConGroup](/en/docs/mt5/api/config_group/imtcongroup), [IMTConSymbol](/en/docs/mt5/api/config_symbol/imtconsymbol), [IMTConGroup](/en/docs/mt5/api/config_group/imtcongroup) etc.) are also not thread safe. When accessing the same object from two threads, the programmer must ensure synchronization of access.

<table class="attentable" cellspacing="0" cellpadding="8" border="1"><tbody><tr class="attentable"><td class="attentable"><p class="p_tableatten"><span class="f_tableatten">All report module components must be thread safe.</span></p></td></tr></tbody></table>
