...
> Source: https://support.metaquotes.net/en/docs/mt5/api/config_subscription
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Configuration Interfaces](/en/docs/mt5/api/reference_configurations)Subscriptions
...
The interfaces described in this section enable the management of subscription settings:

-   [IMTConSubscription](/en/docs/mt5/api/config_subscription/imtconsubscription) — methods for getting and changing subscription settings.
-   [IMTConSubscriptionSymbol](/en/docs/mt5/api/config_subscription/imtconsubscriptionsymbol) — methods for getting and changing symbol settings in subscription configurations.
-   [IMTConSubscriptionNews](/en/docs/mt5/api/config_subscription/imtconsubscriptionnews) — methods for getting and changing news settings in subscription configurations.
-   [IMTConSubscriptionSink](/en/docs/mt5/api/config_subscription/imtconsubscriptionsink) — subscription configuration change event handlers.

[OnKYCSync](/en/docs/mt5/api/config_kyc/imtconkycsink/imtconkycsink_onkycsync)
