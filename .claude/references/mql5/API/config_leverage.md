...
> Source: https://support.metaquotes.net/en/docs/mt5/api/config_leverage
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Configuration Interfaces](/en/docs/mt5/api/reference_configurations)Floating Margin
...
-   [IMTConLeverage](/en/docs/mt5/api/config_leverage/imtconleverage): get and update a floating margin configuration.
-   [IMTConLeverageArray](/en/docs/mt5/api/config_leverage/imtconleveragearray): work with the array of floating margin configurations.
-   [IMTConLeverageRule](/en/docs/mt5/api/config_leverage/imtconleveragerule): get and update floating margin configuration rules.
-   [IMTConLeverageTier](/en/docs/mt5/api/config_leverage/imtconleveragetier): get and update levels in a floating margin rule.
-   [IMTConLeverageSink](/en/docs/mt5/api/config_leverage/imtconleveragesink): track and intercept events related to changes in floating margin configurations.
