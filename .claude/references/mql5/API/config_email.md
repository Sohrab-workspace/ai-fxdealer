...
> Source: https://support.metaquotes.net/en/docs/mt5/api/config_email
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Configuration Interfaces](/en/docs/mt5/api/reference_configurations)Mail Servers
...
The interfaces described in this section enable the management of mail server settings:

-   [IMTConEmail](/en/docs/mt5/api/config_email/imtconemail) — methods for getting and changing mail server configurations.
-   [IMTConEmailSink](/en/docs/mt5/api/config_email/imtconemailsink) — event handlers for the mail server configuration changes.
