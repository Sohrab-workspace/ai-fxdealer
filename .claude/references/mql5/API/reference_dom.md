...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reference_dom
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Database Interfaces](/en/docs/mt5/api/reference_bases)Depth of Market

# Price Data

The MetaTrader 5 API provides the [IMTBookSink](/en/docs/mt5/api/reference_dom/imtbooksink) interface which allows to track changes in the Market Depth of financial instruments.
