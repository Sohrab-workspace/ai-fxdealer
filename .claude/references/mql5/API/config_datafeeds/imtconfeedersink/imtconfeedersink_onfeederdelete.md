...
> Source: https://support.metaquotes.net/en/docs/mt5/api/config_datafeeds/imtconfeedersink/imtconfeedersink_onfeederdelete
        ...
        -   [Configuration Interfaces](/en/docs/mt5/api/reference_configurations)
            ...
            -   [Data Feeds](/en/docs/mt5/api/config_datafeeds)
                ...
                -   [IMTConFeederSink](/en/docs/mt5/api/config_datafeeds/imtconfeedersink)
                    -   [OnFeederAdd](/en/docs/mt5/api/config_datafeeds/imtconfeedersink/imtconfeedersink_onfeederadd)
                    -   [OnFeederUpdate](/en/docs/mt5/api/config_datafeeds/imtconfeedersink/imtconfeedersink_onfeederupdate)
                    -   [OnFeederDelete](/en/docs/mt5/api/config_datafeeds/imtconfeedersink/imtconfeedersink_onfeederdelete)
                    -   [OnFeederSync](/en/docs/mt5/api/config_datafeeds/imtconfeedersink/imtconfeedersink_onfeedersync)
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Configuration Interfaces](/en/docs/mt5/api/reference_configurations)[Data Feeds](/en/docs/mt5/api/config_datafeeds)[IMTConFeederSink](/en/docs/mt5/api/config_datafeeds/imtconfeedersink)OnFeederDelete
...
<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">virtual&nbsp;void&nbsp;&nbsp;</span><span class="f_Functions">IMTConFeederSink::OnFeederDelete</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">const&nbsp;IMTConFeeder*</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Param">feeder</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Pointer&nbsp;to&nbsp;the&nbsp;configuration&nbsp;object</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>

.NET (Gateway/Manager API)

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">virtual&nbsp;void&nbsp;&nbsp;</span><span class="f_Functions">CIMTConFeederSink.OnFeederDelete</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">CIMTConFeeder</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Param">feeder</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Configuration&nbsp;object</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>
