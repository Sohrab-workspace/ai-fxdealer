...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtadminapi/imtadminapi_common/imtadminapi_loggeroutstring
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Manager API](/en/docs/mt5/api/managerapi)[Administrator Interface](/en/docs/mt5/api/imtadminapi)[Common Functions](/en/docs/mt5/api/imtadminapi/imtadminapi_common)LoggerOutString
...
Compared to [IMTAdminAPI::LoggerOut](/en/docs/mt5/api/imtadminapi/imtadminapi_common/imtadminapi_loggerout) which formats the output, this method consumes less resources.
