...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtadminapi/imtadminapi_tick/imtadminapi_tickreplace
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Manager API](/en/docs/mt5/api/managerapi)[Administrator Interface](/en/docs/mt5/api/imtadminapi)[Tick Data](/en/docs/mt5/api/imtadminapi/imtadminapi_tick)TickReplace
...
\[in\]  An array of [MTTickShort](/en/docs/mt5/api/mttickshort) structures describing new ticks.
