...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtadminapi/imtadminapi_tick/imtadminapi_tickrequestraw
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Manager API](/en/docs/mt5/api/managerapi)[Administrator Interface](/en/docs/mt5/api/imtadminapi)[Tick Data](/en/docs/mt5/api/imtadminapi/imtadminapi_tick)TickRequestRaw
...
If the option of storing raw prices is disabled in symbol settings ([IMTConSymbol::TickFlags](/en/docs/mt5/api/config_symbol/imtconsymbol/imtconsymbol_tickflags)), only quotes received by the server will be returned, which is similar to calling [IMTAdminAPI::TickRequest](/en/docs/mt5/api/imtadminapi/imtadminapi_tick/imtadminapi_tickrequest).

After being used, the array of structures [MTTickShort](/en/docs/mt5/api/mttickshort) must be released using the [IMTAdminAPI::Free](/en/docs/mt5/api/imtadminapi/imtadminapi_common/imtadminapi_free) method.
