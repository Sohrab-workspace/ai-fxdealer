...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtadminapi/imtadminapi_trading/imtadminapi_trading_deal/imtadminapi_dealperform
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Manager API](/en/docs/mt5/api/managerapi)[Administrator Interface](/en/docs/mt5/api/imtadminapi)[Trade Databases](/en/docs/mt5/api/imtadminapi/imtadminapi_trading)[Deals](/en/docs/mt5/api/imtadminapi/imtadminapi_trading/imtadminapi_trading_deal)DealPerform
...
<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">MTRetCode&nbsp;&nbsp;</span><span class="f_Functions">CIMTAdminAPI.DealPerform</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">CIMTDeal</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Param">deal</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;deal&nbsp;object</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>

Python

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Functions">AdminAPI.DealPerform</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Param">deal</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">#&nbsp;deal&nbsp;object</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>

Parameters

deal

\[in/out\]  Deal object. The deal object must be first created using the [IMTAdminAPI::DealCreate](/en/docs/mt5/api/imtadminapi/imtadminapi_trading/imtadminapi_trading_deal/imtadminapi_dealcreate) method.
...
It is not recommended to call the IMTAdminAPI::DealPerform method from the [IMTDealSink::OnDealAdd](/en/docs/mt5/api/reference_trading/trading_deal/imtdealsink/imtdealsink_ondealadd), [IMTDealSink::OnDealUpdate](/en/docs/mt5/api/reference_trading/trading_deal/imtdealsink/imtdealsink_ondealupdate) and [IMTDealSink::OnDealPerform](/en/docs/mt5/api/reference_trading/trading_deal/imtdealsink/imtdealsink_ondealperform) handlers.
