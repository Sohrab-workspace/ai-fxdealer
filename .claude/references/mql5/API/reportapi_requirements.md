...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reportapi_requirements
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)Requirements for Modules
