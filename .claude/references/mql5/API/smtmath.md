...
> Source: https://support.metaquotes.net/en/docs/mt5/api/smtmath
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Tools](/en/docs/mt5/api/reference_tools)SMTMath

# SMTMath

The auxiliary functions of mathematical transformationsare divided into groups:

-   [Price Functions](/en/docs/mt5/api/smtmath/smtmath_price)
-   [Volume Functions](/en/docs/mt5/api/smtmath/smtmath_volume)
-   [Functions of Monetary Units](/en/docs/mt5/api/smtmath/smtmath_money)

MT5APIMath.h also contains descriptions of [price and volume constants](/en/docs/mt5/api/smtmath/smtmath_constants).
