...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reference_geo/imtgeo/imtgeo_ipv4from
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Database Interfaces](/en/docs/mt5/api/reference_bases)[Geo Services](/en/docs/mt5/api/reference_geo)[IMTGeo](/en/docs/mt5/api/reference_geo/imtgeo)IPv4From

# IMTGeo::IPv4From

Get the beginning of the range of IPv4 addresses.

C++

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">ULONG&nbsp;&nbsp;</span><span class="f_Functions">IMTGeo::IPv4From</span><span class="f_CodeExample">()</span><span class="f_Keywords">&nbsp;&nbsp;const</span></p></td></tr></tbody></table>

.NET (Gateway/Manager API)

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">ulong&nbsp;&nbsp;</span><span class="f_Functions">CIMTGeo.IPv4From</span><span class="f_CodeExample">()</span></p></td></tr></tbody></table>

Return Value

Beginning of the range of IPv4 addresses.
