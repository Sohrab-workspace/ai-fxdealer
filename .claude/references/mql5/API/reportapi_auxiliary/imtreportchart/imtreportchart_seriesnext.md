...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reportapi_auxiliary/imtreportchart/imtreportchart_seriesnext
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Diagram Interfaces](/en/docs/mt5/api/reportapi_auxiliary)[IMTReportChart](/en/docs/mt5/api/reportapi_auxiliary/imtreportchart)SeriesNext

# IMTReportChart::SeriesNext

Get an object of a [data series](/en/docs/mt5/api/reportapi_auxiliary/imtreportseries) by its position.

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">IMTReportSeries*&nbsp;&nbsp;</span><span class="f_Functions">IMTReportChart::SeriesNext</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">const&nbsp;UINT</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Param">pos</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Position</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>
...
Removal of the returned object (by calling [IMTReportChart::Release](/en/docs/mt5/api/reportapi_auxiliary/imtreportchart/imtreportchart_release)) will cause the pointer stored within the chart object to become invalid, and its call (including the case of the chart object deletion) will cause the crash of the plugin and the server.
