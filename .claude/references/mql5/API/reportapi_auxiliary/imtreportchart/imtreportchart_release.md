# IMTReportChart::Release

> Source: https://support.metaquotes.net/en/docs/mt5/api/reportapi_auxiliary/imtreportchart/imtreportchart_release
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Diagram Interfaces](/en/docs/mt5/api/reportapi_auxiliary)[IMTReportChart](/en/docs/mt5/api/reportapi_auxiliary/imtreportchart)Release
