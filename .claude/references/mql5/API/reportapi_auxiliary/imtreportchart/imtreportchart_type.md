...
> Source: https://support.metaquotes.net/en/docs/mt5/api/reportapi_auxiliary/imtreportchart/imtreportchart_type
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Report API](/en/docs/mt5/api/reportapi)[Diagram Interfaces](/en/docs/mt5/api/reportapi_auxiliary)[IMTReportChart](/en/docs/mt5/api/reportapi_auxiliary/imtreportchart)Type
...
A value of the [IMTReportChart::EnChartType](/en/docs/mt5/api/reportapi_auxiliary/imtreportchart/imtreportchart_enum#encharttype) enumeration.

# IMTReportChart::Type

Set a diagram type.

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">MTAPIRES&nbsp;&nbsp;</span><span class="f_Functions">IMTReportChart::Type</span><span class="f_CodeExample">(</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;</span><span class="f_Keywords">const&nbsp;UINT</span><span class="f_CodeExample">&nbsp;&nbsp;</span><span class="f_Param">type</span><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="f_Comments">//&nbsp;Type&nbsp;of&nbsp;a&nbsp;diagram</span><br><span class="f_CodeExample">&nbsp;&nbsp;&nbsp;)</span></p></td></tr></tbody></table>

Parameters

type

\[in\]  Type of a diagram. To pass the options, the [IMTReportChart::EnChartType](/en/docs/mt5/api/reportapi_auxiliary/imtreportchart/imtreportchart_enum#encharttype) enumeration is used.
