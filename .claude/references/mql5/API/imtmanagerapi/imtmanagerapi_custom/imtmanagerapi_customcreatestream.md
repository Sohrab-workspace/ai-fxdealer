...
> Source: https://support.metaquotes.net/en/docs/mt5/api/imtmanagerapi/imtmanagerapi_custom/imtmanagerapi_customcreatestream
...
[MetaTrader 5](/en/docs/mt5)[API](/en/docs/mt5/api)[Manager API](/en/docs/mt5/api/managerapi)[Manager Interface](/en/docs/mt5/api/imtmanagerapi)[Custom Functions](/en/docs/mt5/api/imtmanagerapi/imtmanagerapi_custom)CustomCreateStream
...
<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">IMTByteStream*&nbsp;&nbsp;</span><span class="f_Functions">IMTManagerAPI::CustomCreateStream</span><span class="f_CodeExample">()</span></p></td></tr></tbody></table>

.NET

<table class="help" cellspacing="0" cellpadding="3" border="0" style="border:none; border-spacing:0;"><tbody><tr><td style="vertical-align:top; padding:3px; border:none"><p class="p_CodeExample"><span class="f_Keywords">CIMTByteStream&nbsp;&nbsp;</span><span class="f_Functions">CIMTManagerAPI.CustomCreateStream</span><span class="f_CodeExample">()</span></p></td></tr></tbody></table>

Return Value

It returns a pointer to the created object that implements the [IMTByteStream](/en/docs/mt5/api/reference_bytestream/imtbytestream) interface. In case of failure, it returns NULL.

Note

The created object must be deleted by calling the [IMTByteStream::Release](/en/docs/mt5/api/reference_bytestream/imtbytestream/imtbytestream_release) method of this object.
