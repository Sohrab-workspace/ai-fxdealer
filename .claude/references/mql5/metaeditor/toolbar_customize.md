...
> Source: https://support.metaquotes.net/en/docs/mt5/metaeditor/toolbar_customize
...
-   [MetaTrader 5](/en/docs/mt5)
    ...
    -   [MetaEditor](/en/docs/mt5/metaeditor)
        ...
        -   [Toolbars](/en/docs/mt5/metaeditor/toolbar)
            -   [Standard](/en/docs/mt5/metaeditor/toolbar_standard)
            -   [Search](/en/docs/mt5/metaeditor/toolbar_search)
...
[MetaTrader 5](/en/docs/mt5)[MetaEditor](/en/docs/mt5/metaeditor)[Toolbars](/en/docs/mt5/metaeditor/toolbar)Setup

# Setup

To change a set of commands on the [Standard](/en/docs/mt5/metaeditor/toolbar) toolbar, click "Customize..." in its context menu.

![Customizing the toolbar](/en/docs/mt5/metaeditor/img/toolbar_customize.png "Customizing the toolbar")
...
<table class="attentable" cellspacing="0" cellpadding="8" border="1"><tbody><tr class="attentable"><td class="attentable"><p class="p_tableatten"><span class="f_tableatten">If you remove all the buttons from the list of selected ones and close the toolbar setup window, the default set of commands is restored.</span></p></td></tr></tbody></table>
