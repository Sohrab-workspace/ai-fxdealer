...
> Source: https://support.metaquotes.net/en/docs/mt5/metaeditor/mql5storage
...
[MetaTrader 5](/en/docs/mt5)[MetaEditor](/en/docs/mt5/metaeditor)Projects and MQL5 Storage
...
The storage allows you to easily share and synchronize [chart templates and profiles](https://www.metatrader5.com/en/terminal/help/charts_advanced/templates_profiles), sets of parameters for testing MQL5 programs and sets of trading instruments between different platforms.

MQL5 Storage allows remote development of MQL5 applications in teams using [shared projects](/en/docs/mt5/metaeditor/projects).

![MQL5 Storage](/en/docs/mt5/metaeditor/img/mql5_storage.png "MQL5 Storage")
