...
> Source: https://support.metaquotes.net/en/docs/mt5/android/chart/indicators/trend_indicators/moving_average
        ...
        -   [Charts](/en/docs/mt5/android/chart)
            -   [Indicators](/en/docs/mt5/android/chart/indicators)
                -   [Trend Indicators](/en/docs/mt5/android/chart/indicators/trend_indicators)
                    -   [Average Directional Movement Index](/en/docs/mt5/android/chart/indicators/trend_indicators/average_directional_movement_index)
                    -   [Bollinger Bands](/en/docs/mt5/android/chart/indicators/trend_indicators/bollinger_bands)
                    -   [Envelopes](/en/docs/mt5/android/chart/indicators/trend_indicators/envelopes)
                    -   [Ichimoku Kinko Hyo](/en/docs/mt5/android/chart/indicators/trend_indicators/ichimoku_kinko_hyo)
                    -   [Moving Average](/en/docs/mt5/android/chart/indicators/trend_indicators/moving_average)
                    -   [Parabolic SAR](/en/docs/mt5/android/chart/indicators/trend_indicators/parabolic_sar)
                    -   [Standard Deviation](/en/docs/mt5/android/chart/indicators/trend_indicators/standard_deviation)
                    -   [ZigZag](/en/docs/mt5/android/chart/indicators/trend_indicators/zigzag)
...
[MetaTrader 5](/en/docs/mt5)[Android](/en/docs/mt5/android)[Charts](/en/docs/mt5/android/chart)[Indicators](/en/docs/mt5/android/chart/indicators)[Trend Indicators](/en/docs/mt5/android/chart/indicators/trend_indicators)Moving Average
...
There are four different types of moving averages: [Simple](/en/docs/mt5/android/chart/indicators/trend_indicators/moving_average#sma) (also referred to as Arithmetic), [Exponential](/en/docs/mt5/android/chart/indicators/trend_indicators/moving_average#ema), [Smoothed](/en/docs/mt5/android/chart/indicators/trend_indicators/moving_average#smma) and [Weighted](/en/docs/mt5/android/chart/indicators/trend_indicators/moving_average#lwma). Moving Average may be calculated for any sequential data set, including opening and closing prices, highest and lowest prices, trading volume or any other indicators. It is often the case when double moving averages are used.

The only thing where moving averages of different types diverge considerably from each other, is when weight coefficients, which are assigned to the latest data, are different. In case of the [Simple Moving Average](/en/docs/mt5/android/chart/indicators/trend_indicators/moving_average#sma), all prices of the time period in question are equal in weight. [Exponential Moving Average](/en/docs/mt5/android/chart/indicators/trend_indicators/moving_average#ema) and [Linear Weighted Moving Average](/en/docs/mt5/android/chart/indicators/trend_indicators/moving_average#lwma) assign more weight to the latest prices.
...
![Moving Average](/en/docs/mt5/android/img/moving_average.png "Moving Average")
