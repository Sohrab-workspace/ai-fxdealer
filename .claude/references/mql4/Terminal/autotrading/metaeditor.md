...
> Source: https://support.metaquotes.net/en/docs/mt4/terminal/autotrading/metaeditor
...
[MetaTrader 4](/en/docs/mt4)[Client terminal](/en/docs/mt4/terminal)[Auto Trading](/en/docs/mt4/terminal/autotrading)MetaEditor

# MetaEditor

MetaEditor is a constituent of the client terminal. It is intended for creation, editing, and compilation of program source codes written in [MetaQuotes Language 4 (MQL4)](/en/docs/mt4/terminal/autotrading/mql4). It can be used in developing of [experts](/en/docs/mt4/terminal/autotrading/experts), [custom indicators](/en/docs/mt4/terminal/autotrading/custom_indicators), [scripts](/en/docs/mt4/terminal/autotrading/scripts) and DLL's.
