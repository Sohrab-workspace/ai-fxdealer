...
> Source: https://support.metaquotes.net/en/docs/mt4/terminal/analytics/tech_indicators/force_index
...
![chart_FRC](/en/docs/mt4/terminal/img/chart_frc.png)
...
MA (ApPRICE, N, i) — any [Moving Average](/en/docs/mt4/terminal/analytics/tech_indicators/moving_average) of the current bar for N period:  
[Simple](/en/docs/mt4/terminal/analytics/tech_indicators/moving_average#simple_moving_average), [Exponential](/en/docs/mt4/terminal/analytics/tech_indicators/moving_average#exponential_moving_average), [Weighted](/en/docs/mt4/terminal/analytics/tech_indicators/moving_average#linear_weighted_moving_average) or [Smoothed](/en/docs/mt4/terminal/analytics/tech_indicators/moving_average#smoothed_moving_average);  
ApPRICE — applied price;  
N — period of the smoothing;  
MA (ApPRICE, N, i-1) — any [Moving Average](/en/docs/mt4/terminal/analytics/tech_indicators/moving_average) of the previous bar.
