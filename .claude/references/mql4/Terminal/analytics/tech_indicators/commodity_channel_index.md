...
> Source: https://support.metaquotes.net/en/docs/mt4/terminal/analytics/tech_indicators/commodity_channel_index
...
[MetaTrader 4](/en/docs/mt4)[Client terminal](/en/docs/mt4/terminal)[Analytics](/en/docs/mt4/terminal/analytics)[Technical Indicators](/en/docs/mt4/terminal/analytics/tech_indicators)Commodity Channel Index
...
![chart_CCI](/en/docs/mt4/terminal/img/chart_cci.png)
...
1.  To calculate the n-period [Simple Moving Average](/en/docs/mt4/terminal/analytics/tech_indicators/moving_average#simple_moving_average) of typical prices.

SMA(TP, N) = SUM\[TP, N\]/N

1.  To subtract the received SMA(TP, N) from Typical Prices.

D = TP — SMA(TP, N)

1.  To calculate the n-period [Simple Moving Average](/en/docs/mt4/terminal/analytics/tech_indicators/moving_average#simple_moving_average) of absolute D values.

SMA(D, N) = SUM\[D, N\]/N

1.  To multiply the received SMA(D, N) by 0,015.
