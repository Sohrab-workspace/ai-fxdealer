...
> Source: https://support.metaquotes.net/en/docs/mt4/manager/user_interface
...
[MetaTrader 4](/en/docs/mt4)[Manager](/en/docs/mt4/manager)User Interface

# User Interface

This section describe the elements of interface of the manager terminal:
