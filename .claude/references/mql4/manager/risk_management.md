...
> Source: https://support.metaquotes.net/en/docs/mt4/manager/risk_management
...
[MetaTrader 4](/en/docs/mt4)[Manager](/en/docs/mt4/manager)Risk Management

# Risk Management

This sections describes how to cover client positions and protect own company from financial risk:
