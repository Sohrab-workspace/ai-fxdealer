...
> Source: https://support.metaquotes.net/en/docs/mt4/manager/request_processing
...
[MetaTrader 4](/en/docs/mt4)[Manager](/en/docs/mt4/manager)Request Processing

# Request Processing

This section describes dealing features of the manager terminal:
