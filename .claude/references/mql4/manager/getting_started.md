...
> Source: https://support.metaquotes.net/en/docs/mt4/manager/getting_started
...
[MetaTrader 4](/en/docs/mt4)[Manager](/en/docs/mt4/manager)Getting Started

# Getting Started

This section contains basic information you need to know when starting to work with the administrator terminal:
