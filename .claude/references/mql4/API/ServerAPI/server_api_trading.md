...
> Source: https://support.metaquotes.net/en/docs/mt4/api/server_api/server_api_trading
    ...
    -   [API](/en/docs/mt4/api)
        ...
        -   [Server API](/en/docs/mt4/api/server_api)
            ...
            -   [Trading](/en/docs/mt4/api/server_api/server_api_trading)
                -   [Orders](/en/docs/mt4/api/server_api/server_api_trading/server_api_trading_order)
                -   [Trade Requests](/en/docs/mt4/api/server_api/server_api_trading/server_api_trading_request)
                -   [Service Calculations](/en/docs/mt4/api/server_api/server_api_trading/server_api_trading_trade)
                -   [Trade Checks](/en/docs/mt4/api/server_api/server_api_trading/server_api_trading_check)
...
[MetaTrader 4](/en/docs/mt4)[API](/en/docs/mt4/api)[Server API](/en/docs/mt4/api/server_api)Trading

# Trading

The functions described in this section are used for operations with the trading part of the MetaTrader 4 platform.
