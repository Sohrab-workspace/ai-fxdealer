...
> Source: https://support.metaquotes.net/en/docs/mt4/api/manager_api/manager_api_exposure
    ...
    -   [API](/en/docs/mt4/api)
        ...
        -   [Manager API](/en/docs/mt4/api/manager_api)
            ...
            -   [Exposure](/en/docs/mt4/api/manager_api/manager_api_exposure)
                -   [ExposureGet](/en/docs/mt4/api/manager_api/manager_api_exposure/cmanagerinterface_exposureget)
                -   [ExposureValueGet](/en/docs/mt4/api/manager_api/manager_api_exposure/cmanagerinterface_exposurevalueget)
...
[MetaTrader 4](/en/docs/mt4)[API](/en/docs/mt4/api)[Manager API](/en/docs/mt4/api/manager_api)Exposure

# Exposure

MetaTrader 4 Manager API allows to receive information about clients' exposure and company's hedged assets.

<table class="table" cellspacing="0" cellpadding="5" border="1"><thead><tr class="table"><th class="table" style="width:151px;"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Function</span></p></th><th class="table"><p class="p_fortable"><span class="f_fortable" style="font-weight: bold;">Purpose</span></p></th></tr></thead><tbody><tr class="table"><td class="table" style="width:151px;"><p class="p_fortable"><span class="f_fortable"><a href="/en/docs/mt4/api/manager_api/manager_api_exposure/cmanagerinterface_exposureget" class="topiclink">ExposureGet</a></span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Receiving information about all clients' assets and company's hedged assets.</span></p></td></tr><tr class="table"><td class="table" style="width:151px;"><p class="p_fortable"><span class="f_fortable"><a href="/en/docs/mt4/api/manager_api/manager_api_exposure/cmanagerinterface_exposurevalueget" class="topiclink">ExposureValueGet</a></span></p></td><td class="table"><p class="p_fortable"><span class="f_fortable">Receiving information about clients' exposure and company's hedged assets with the specified names.</span></p></td></tr></tbody></table>
