...
> Source: https://support.metaquotes.net/en/docs/mt4/multiterminal/user_interface
...
[MetaTrader 4](/en/docs/mt4)[MultiTerminal](/en/docs/mt4/multiterminal)User Interface

# User Interface

The user interface includes the following instruments:
