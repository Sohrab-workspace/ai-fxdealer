...
> Source: https://support.metaquotes.net/en/docs/mt4/administrator/server_commands
...
[MetaTrader 4](/en/docs/mt4)[Administrator](/en/docs/mt4/administrator)Server Administration Commands

# Server Administration Commands

In this section you can find the description of service commands used when working with servers:
