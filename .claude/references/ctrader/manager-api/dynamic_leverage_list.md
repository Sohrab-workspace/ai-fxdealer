# Dynamic Leverage List

**Category:** profiles &nbsp;|&nbsp; **Status:** ✅ Live

## Description

Returns dynamic leverage tiers — where leverage decreases as position size grows.

---

## Request — `ProtoDynamicLeverageListReq` (payloadType `469`)
...
fields = c.request(
    PT["DYNAMIC_LEVERAGE_LIST_REQ"],
    PT["DYNAMIC_LEVERAGE_LIST_RES"],
    inner
)
...
## Response — `ProtoDynamicLeverageListRes` (payloadType `470`)

### Response Fields

| Field | Type | Description |
|-------|------|-------------|
| `dynamicLeverage` | `ProtoDynamicLeverage[]` | Profile ID, name, volume tiers + leverage values |
  ...
  "2": [
    {
      "1": 1009,
      "2": "Strategy Symbols",
      "3": "Default leverage for Strategy Symbols",
      "4": {
        "1": 100,
        "2": 100
      },
...
Applied per-symbol. Required for risk management in heavily leveraged accounts.
